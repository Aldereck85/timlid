...
$titulo = 'Lista de Tipos de Inventario';
      ...
      <form action="" method="POST">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <input class="form-control" id="notaTipoOrdenInventario" name="notaTipoOrdenInventario"
                        type="hidden" style="color: darkred; background-color: transparent!important; border: none;"
                        value="Nota: El tipo de orden ya existe." readonly>
                    </div>
                  </div>
                </div>
                <br>
        ...
        <div class="modal-footer justify-content-end">
          ...
          <button type="submit" class="btn-custom btn-custom--blue" name="btnAgregarTipoOrdenInventario"
            id="btnAgregarTipoOrdenInventario"><span class="ajusteProyecto" data-dismiss="modal"
...
<div class="modal fade right" id="editar_TipoOrdenInventario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <!-- Add class .modal-full-height and then add class .modal-right (or other classes from list above) to set a position to the modal -->
  <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
    <div class="modal-content">
      <form action="" method="POST">
              ...
              <form id="formDatosCategoriaU">
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-lg-5">
                      <select class="form-control" name="cmbEstatusTipoOrdenInventario"
                        id="cmbEstatusTipoOrdenInventario" required="" onchange="cambiarColor()">
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <input class="form-control" id="notaTipoOrdenInventarioU" name="notaTipoOrdenInventarioU"
                        type="hidden" style="color: darkred; background-color: transparent!important; border: none;"
                        value="Nota: El tipo de orden ya existe." readonly>
                    </div>
                  </div>
        ...
        <div class="modal-footer justify-content-end">
          ...
          <a aria-label="Close" class="btn-custom btn-custom--border-blue btnCancelarActualizacion" data-toggle="modal"
            data-target="#eliminar_TipoOrdenInventario" name="btnEliminarTipoOrdenInventarioU"
          ...
          <button type="submit" class="btn-custom btn-custom--blue" name="btnEditarTipoOrdenInventario"
            id="btnEditarTipoOrdenInventario"><span class="ajusteProyecto" data-dismiss="modal">Guardar</span></button>
        </div>
      </form>
    </div>
  </div>
