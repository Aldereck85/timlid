          ...
          <div class="card shadow mb-4" id="divCalculo">
            ...
            <form action="" method="post" id="frmNomina">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <label class="float-right" id="lblBonoAsignado"><?=number_format($bonoAsignado, 2, '.', '');?></label>
                  </div>
                  <div class="col-lg-3">
                  </div>
                  <div class="col-lg-3">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <label name="lblBono" id="lblBono" class="float-right"><?=number_format($bonoAsignado, 2, '.', '');?></label>
                    <input type="hidden" name="txtBono" id="txtBono" value="<?=number_format($bonoAsignado, 2, '.', '');?>">
                    <input type="hidden" name="txtBonoPuesto" id="txtBonoPuesto" value="<?=number_format($bonoAsignado, 2, '.', '');?>">
