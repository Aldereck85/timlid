  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE datos_contacto_proveedores set Nombre= :nombre,Apellido_Paterno= :apellido,Puesto= :puesto,Telefono= :telefono,Celular= :celular,Email= :email WHERE PKContacto_Proveedor = :id');
      ...
      if(isset($_POST['txtIdContactoU'])){
        $id =  $_POST['txtIdContactoU'];
        $stmt = $conn->prepare('SELECT * FROM datos_contacto_proveedores WHERE PKContacto_Proveedor= :id');
