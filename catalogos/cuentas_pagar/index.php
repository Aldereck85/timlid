               ...
               <div class="card mb-4">
                  <div class="card-body">
                     <div class="form-group">
                        <div class="row">
                           <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-xs-6" style="margin-left:20px;">
                              ...
                              <select name="cmbProveedor" id="cmbProveedor" class="form-select" required></select>
                              <div class="invalid-feedback" id="invalid-cmbProveedor">.</div>
                           </div>
                     ...
                     <div class="table-responsive">
                        <div id="tabla">
                           <table class="table" id="tblproveedor" width="100%" cellspacing="0">
                              <thead>
                                 <tr>
                                    <th>Proveedor</th>
                                    <th>De 1 - 30 Dias</th>
                        ...
                        <div id="tabla_histo">
                           <table class="table" id="tblhistorico" style="width: 100%;" cellspacing="0">
                              <thead>
                                 <tr>
                                    <th>Id</th>
                                    <th>Proveedor</th>
