      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-address-book"></i> Editar prospecto</h1>
          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              ...
                              <div class="input-group mb-3">
                                <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtMedio"
                                  value="<?=$medio;?>">
                              </div>
                            </div>
                          </div>
