function loadProductsFinderAll(){
  ...
  tblProductsFinder = $("#tblProductsFinderAll").DataTable({
    ...
    <"container-fluid mt-4"<"row"<"#btn-filters-tblProductsFinderAll.col-sm-12 col-md-8 p-0"><"col-sm-12 col-md-4 p-0"p>>>`,
    buttons: {
      dom: {
        button: {
          tag: "button",
    ...
    buttons: [
      {
        ...
        action: function (e, dt, node, config) {
          filtro = "";
          $("#tblProductsFinderAll").DataTable().draw();
        },
      },
      {
  ...
  tblProductsFinder.buttons(1, null).container().appendTo("#btn-filters-tblProductsFinderAll");
