    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO domicilio_de_envio (Calle,Numero_exterior,Numero_Interior,Colonia,Municipio,Estado,CP,Locacion,FKCliente)VALUES(:calle,:numEx,:numInt,:colonia,:municipio,:estado,:cp,:locacion,:fkcliente)');
