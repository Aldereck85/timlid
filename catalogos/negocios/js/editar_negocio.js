$(document).ready(function () {
    ...
    initSelectEmpresaClien();
    initSelectEmpresaPros();
  
    if($("input[name='tipoContacto']:checked").val() == "cliente") {
      $("#div_empreClie").removeClass("d-none");
      $("#div_emprePros").addClass("d-none");
      loadContactos("cliente", $("#empresaClieSelect").val());
    }else{
      loadContactos("prospecto", $("#empresaProsSelect").val());
    }
    ...
    $("#btnEditarNegocio").click(function (e) {
      e.preventDefault();
      ...
      if (
        ...
        var accion = "editarNegocio";
        var negocio_id = $("#idNegocioHdd").val();
    ...
    $("#btnEliminarNegocio").click(function (e) {
      e.preventDefault();
      var negocio_id = $("#idNegocioHdd").val();
      var accion = "eliminarNegocio";
      Swal.fire({
        title: "Eliminar negocio",
        html:
          "<div class='container'" +
          "<div class='row'>" +
          "<p class='col-12 text-center'>¿Deseas eliminar este negocio?</p>" +
          "</div>" +
          "</div>",
    ...
    function loadContactos(tipo, id) {
      const contacto = $("#contactoHdd").val();
      var accion = "cargarContactosTipoEditar";
      $.ajax({
  ...
  function initSelectPriridad() {
    //let alta, media, baja;
    switch(parseInt($("#prioridadHdd").val())){
      case 1:
        new SlimSelect({
          select: "#prioridad",
