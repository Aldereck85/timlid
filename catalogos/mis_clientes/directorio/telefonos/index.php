...
<head>
  ...
  <title>Timlid | Telefonos de clientes</title>
  ...
  <script>
    $(document).ready(function(){
      ...
      var id = $("#txtId").val();
      $("#divAgregar").html('<a href="funciones/agregar_Telefono.php?id='+id+'" class="btn btn-success float-right" ><i class="fas fa-plus"></i> Agregar telefono </a>');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Numeros de telefono</h1>
          <p class="mb-4">Directorio de telefonos del cliente</p>
