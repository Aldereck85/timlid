    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card-body">
            <input type="hidden" value="<?=$facturar;?>" id="txtFacturar">
            <input type="hidden" value="<?=$select;?>" id="txtSelect">
		    <input type="hidden" value="<?=$prefactura;?>" id="txtPrefactura">
            <input type="hidden" id="txtClientePrefactura">
            <input type="hidden" id="txtTipoPrefactura">
            <input type="hidden" id="txtReferenciaPrefactura">
            <input type="hidden" name="txtDocumento" id="txtDocumento">
            <input type="hidden" name="alertSat" id="alertSat">
              <div class="cabecera">
                ...
                <div class="row cabecera-selector">
                  <div class="col-lg-4 comboFacturarDesde">
                    <label for="">Facturar desde:</label>
                    <select name="cmbFacturarDesde" id="cmbFacturarDesde">
                  ...
                  <div class="col-lg-4" id="comboCliente">
                    <label for="">Cliente:</label>
                    <select name="cmbCliente" id="cmbCliente"></select>
                    <input type="hidden" name="txtCliente" id="txtCliente">
                  </div>
                  <div class="col-lg-4" id="comboCotizacion">
                    <label for="">Cotización:</label>
                    <select name="cmbCotizacion" id="cmbCotizacion"></select>
                    <input type="hidden" name="txtCotizacion" id="txtCotizacion">
                  </div>
                  <div class="col-lg-4" id="comboVentaDirecta">
                    <label for="">Venta directa:</label>
                    <select name="cmbVentaDirecta" id="cmbVentaDirecta"></select>
                    <input type="hidden" name="txtVenta" id="txtVenta">
                  </div>
                  <div class="col-lg-4" id="comboRemision">
                    <label for="">Remision:</label>
                    <select name="cmbRemision" id="cmbRemision"></select>
                  </div>
                 
                  <div class="col-lg-4 input-group select-timlid" id="select-pedidos">
                ...
                <div class="row">
                  <div class="col-lg-4 input-group select-timlid" id="select-salidas">
                  ...
                  <div class="col-lg-4" id="btnCargarSalidas">
                ...
                <form class="cabecera-cliente" id="datos-factura">
                  <div id="espacio-facturar"></div>
                  <div class="row form-group">
                    <div class="col-lg-4">
                      <h5>Razón social: <span id="razon_social"></span></h5>
                      <div id="razonSocialPG">
                        <input class="form-control" type="text" name="txtRazonSocialPG" id="txtRazonSocialPG" placeholder="Agregue razon social de cliente">
                  ...
                  <div class="row form-group">
                    <div class="col-lg-4">
                      <div id="preinvoice_exist">
                        <h5>Prefactura: <span id="preinvoice_exist_span"></span></h5>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                      ...
                      <div id="comboCuentaBancaria">
                        ...
                        <input class="form-control" type="text"  name="txaReferencia" id="txaReferencia">
                        <br>
                      </div>
                    ...
                    <div class="col-lg-3">
                      <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="chkAddressInvoice">
                        <label class="custom-control-label" for="chkAddressInvoice">Dirección de facturación</label>
                        
                      </div>
                      <div id="comboAddressInvoice">
                        <select name="cmbAddressInvoice" id="cmbAddressInvoice"></select>
                        <div class="invalid-feedback" id="invalid-addressInvoice">La factura debe de tener una dirección de facturación.</div>
                      </div>
                    </div>
                    -->
                  </div>
                  ...
                  <div class="row form-group">
                    <div class="col-lg-6">
                      <div id="notas_cliente">
                        <label for="txaNotasCliente">Notas del cliente:</label>
                        <textarea class="form-control" name="txaNotasCliente" id="txaNotasCliente" cols="30" rows="2" readonly></textarea>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div id="notas_vendedor">
                        <label for="txaNotasVendedor">Notas internas:</label>
                        <textarea class="form-control" name="txaNotasVendedor" id="txaNotasVendedor" cols="30" rows="2" readonly></textarea>
                      </div> 
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                      <div class="custom-control custom-switch float-left" id="divChkPrefactura">
                      ...
                      <button type="button" class="btn-custom btn-custom--blue espAgregar float-right" name="btnAgregar" id="agregarFactura" style="margin-left:5px"><span
...
<!--
    ...
    <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
            ...
            <button type="button" class="btn-custom btn-custom--blue espAgregar float-right" name="btnAgregar" id="btnEditarProducto"><span
                class="ajusteProyecto">Guardar</span></button>
          </div>
  ...
  <script src="js/agregar_factura.js"></script>
