...
<head>
  ...
  <title>Timlid | Mis clientes</title>
  ...
  $(document).ready(function() {
    ...
    $("#tblClientes").dataTable({
      ...
      "lengthChange": false,
      "info": false,
      "ajax": "functions/function_Clientes.php?id=" + id,
      "columns": [{
          "data": "Id cliente"
        },
        {
...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-portrait"></i> Mis Clientes</h1>
          <p class="mb-4">Información general de clientes</p>
              ...
              <div class="float-right">
                <div class="button-container2" id="">
                  <div class="button-icon-container">
                    <a href="functions/agregar_Cliente.php"
          ...
          <input type="hidden" name="txtId" id="txtId" value="<?=$_SESSION["PKUsuario"];?>">
        </div>
        <!-- /.container-fluid -->
  ...
  <!-- Delete Modal mis clientes -->
  <div id="eliminar_Cliente" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/eliminar_Cliente.php" method="POST">
          <input type="hidden" name="idClienteD" id="idClienteD">
          <div class="modal-header">
  ...
  <!-- Update Modal mis clientes -->
  <div id="editar_Cliente" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/editar_Cliente.php" method="POST">
  ...
  function obtenerIdClienteEliminar(id) {
    document.getElementById('idClienteD').value = id;
  }

  function obtenerIdClienteEditar(id) {
    document.getElementById('idClienteU').value = id;
  }
