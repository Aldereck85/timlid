...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Información general de los puestos de trabajo</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a href="functions/agregar_Puesto.php" class="btn btn-success float-right" ><i class="fas fa-plus"></i> Agregar puesto </a>
            </div>
            <div class="card-body">
  ...
  <!-- Delete Modal mis puestos -->
  <div id="eliminar_Puesto" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/eliminar_Puesto.php" method="POST">
          <input type="hidden" name="idPuestoD" id="idPuestoD">
  ...
  <!-- Update Modal mis puestos -->
  <div id="editar_Puesto" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/editar_Puesto.php" method="POST">
  ...
  <script>
    function obtenerIdPuestoEliminar(id){
