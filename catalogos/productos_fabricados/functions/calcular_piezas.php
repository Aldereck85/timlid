...
<head>
  ...
  <title>Timlid | Calculo de piezas fabricadas por rollo</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-calculator"></i> Calcular piezas fabricadas por rollo</h1>
          </div>
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <label>Producto fabricado: <?php echo $productoFabricado;?></label><br><br>
                  <div class="row">
                    <div class="col-lg-2">
                      Pieza
                    </div>
                  ...
                  <hr>
                  <?php require_once('impresion_piezas.php'); ?>
