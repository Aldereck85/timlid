  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE telefonos_paqueterias set Telefono= :telefono WHERE PKTelefono_Paqueteria = :id');
      ...
      if(isset($_POST['idTelefonoU'])){
        $id =  $_POST['idTelefonoU'];
        $stmt = $conn->prepare('SELECT * FROM telefonos_paqueterias WHERE PKTelefono_Paqueteria= :id');
