    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO domicilio_fiscal (Razon_Social,RFC,Calle,Numero_exterior,Numero_Interior,Colonia,Municipio,Estado,CP,Locacion,FKCliente)VALUES(:razon,:rfc,:calle,:numEx,:numInt,:colonia,:municipio,:estado,:cp,:locacion,:fkcliente)');
...
<head>
  ...
  <title>Timlid | Agregar datos fiscales</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-file-invoice-dollar"></i> Agregar datos fiscales</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control alphaNumeric-only" maxlength="40" name="txtRazon" required>
                              </div>
                              <div class="col-lg-6">
                                <label for="usr">RFC:</label>
                                <input type="text" class="form-control alphaNumeric-only" maxlength="13" name="txtRFC" required>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-lg-8">
                                <label for="usr">Calle:</label>
                                <input type="text" class="form-control alpha-only" maxlength="20" name="txtCalle" required>
                              </div>
                              <div class="col-lg-2">
                                <label for="usr">Número exterior:</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control numeric-only" maxlength="3" name="txtNumeroEx" required>
                                </div>
                              </div>
                              <div class="col-lg-2">
                            ...
                            <div class="row">
                              <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control alpha-only" maxlength="20" name="txtColonia" required>
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Municipio:</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alpha-only" maxlength="20" name="txtMunicipio" required>
                                </div>
                              </div>
                              <div class="col-lg-4">
                            ...
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control numeric-only" maxlength="20" name="txtCP" required>
                              </div>
                              <div class="col-lg-6">
