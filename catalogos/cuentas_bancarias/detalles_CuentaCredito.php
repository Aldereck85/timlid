...
<body id="page-top" class="sidebar-toggled">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table" id="tblDatosGenerales" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div>Limite de crédito: <span id="limiteCredTbl"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div>Credito Utilizado: <span id="credUtlTbl"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div>Credito Disponible: <span id="credDispTbl"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div>Tipo de cuenta: <span id="tipoCntTbl"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div>Nombre de la cuenta: <span id="nombreCntTbl"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div>Numero de credito: <span id="noCredTbl"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div>Banco: <span id="bancoTbl"></span></div>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="row">
                <div class="col">
                  <div class="row">
                    <div class="col-9">
                      <span class="btn-table-custom btn-table-custom--green" data-toggle="modal" data-target="#" onclick="disponer(<?php echo $idDet; ?>)"><i class="fas fa-minus-circle"></i> Disponer</span>
                      <span class="btn-table-custom btn-table-custom--red" data-toggle="modal" data-target="#credito_Pagar" onclick="pagar(<?php echo $idDet; ?>)"><i class="fas fa-plus-circle"></i> Pagar</span>
          ...
          <div class="card mt-2">
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <div class="table-responsive">
                    <table class="table" id="tblMovimientosCredito" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          <th>Id</th>
                          <th>Fecha</th>
  ...
  <div class="modal fade right" id="credito_Disponer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow-y: scroll;">
    <div class="modal-dialog modal-full-height modal-right  modal-md" role="document">
      <div class="modal-content">
        <form name="formular" action="" id="creditoDisponer" method="POST">
          <input type="hidden" name="idCuentaAc" id="idCuentaAc" style="width: 100px;">
          <input type="hidden" name="saldoDisponible" id="saldoDisponible" style="width: 100px;">
          <input type="hidden" name="moActual" id="moActual" style="width: 100px;">
          <input type="hidden" name="nomCuenta" id="nomCuenta" style="width: 100px;">
          ...
          <div class="modal-body">
            ...
            <div id="aCuenta">
              <div class="form-group">
                <select name="cmbACuenta" class="form-control" id="cmbACuenta" onchange="get_ACuenta(<?php echo $idDet; ?>)">
                </select>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  ...
                  <div class="invalid-feedback" id="invalid-cantidadDisp">La disposición debe tener una cantidad.
                  </div>
                </div>
                <div class="col">
            ...
            <div class="modal-footer justify-content-center">
              ...
              <button type="button" class="btnesp first espAgregar " id="btnAgregarDisposicion" onclick="agregar_Disposicion()"><span class="ajusteProyecto" onclick="" disabled>Guardar</span></button>
            </div>
    ...
    <div class="modal-dialog modal-full-height modal-right  modal-md" role="document">
      <div class="modal-content">
        <form name="formular" action="" id="transferencia" method="POST">
          ...
          <input type="hidden" id="destino" name="destino" value="" style="width: 100px;">
          ...
          <input type="hidden" name="idDestinoT" id="idDestinoT" style="width: 100px;">
          <input type="hidden" name="saldoACuenta" id="saldoACuenta" style="width: 100px;">
          <input type="hidden" name="moDestinoT" id="moDestinoT" style="width: 100px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  <input class="form-control numericDecimal-only" type="numeric" placeholder="Ej: 00.00" name="txtCantidadT" id="txtCantidadT" onkeyup="validEmptyInput(this)">
            ...
            <div id="moneda_diferenteT">
              ...
              <div class="row">
                <div class="col md">
                  <input class="form-control numericDecimal-only" type="numeric" placeholder="" name="tipoDeCambioT" id="tipoDeCambioT">
                </div>
                <div class="col">
                  <input class="form-control" type="text" id="monedaDescripT" name="monedaDescripT" value="" disabled>
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="modal-footer justify-content-center">
              ...
              <button type="button" class="btnesp first espAgregar " id="btnGuardarTransferencia" onclick="guardarTransferenciaCr(<?php echo $idDet; ?>)"><span class="ajusteProyecto">Guardar</span></button>
            </div>
          </div> <!-- end div Class MODAL BODY-->
        </form>
      </div>
    ...
    <div class="modal-dialog modal-full-height modal-right  modal-md" role="document">
      <div class="modal-content">
        <form name="formular" action="" id="creditoPagar" method="POST">
          ...
          <div class="modal-header">
            <h4 class="modal-title w-100" id="myModalLabel">Pagar</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">x</span>
            </button>
          </div>
          <div class="modal-body">
            ...
            <div id="aCuentaP">
              <div class="form-group">
                ...
                <div class="invalid-feedback" id="invalid-cuentaDeposito">El pago debe teber una cuenta de origen.
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  ...
                  <div class="invalid-feedback" id="invalid-cantidadDeposito">El pago debe tener una cantidad.</div>
                </div>
                <div class="col">
                  <input class="form-control" type="text" id="moDescripcionActualP" name="moDescripcionActualP" value="" disabled>
                </div>
              </div>
            </div>
            ...
            <label for="">* Campos requeridos</label>
            <div class="modal-footer justify-content-center">
              <button type="button" class="btnesp first espCancelar btnCancelarActualizacionPago" data-dismiss="modal" id="btnCancelarActualizacionPago"><span class="ajusteProyecto">Cancelar</span></button>
  ...
  <script src="js/funciones_Credito.js" charset="utf-8"></script>
