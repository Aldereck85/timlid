...
$(document).ready(function () {
  ...
  $("#fitro_inventario").click(function () {
    ...
    if (!cate) {
      ...
      $("#categoria_input").addClass("is-invalid");
    }
    if (!exist) {
    ...
    if (badSucursal && badCategoria && badExistencia) {
      showTableInventario(sucu, cate, exist);
    }
  });
});

function showTableInventario(sucu = "todas", cate = "todas", exist = "todos") {
  ...
  $("#tblListadoInventario").DataTable({
    ...
    buttons: {
      ...
      buttons: [
        ...
        {
          text: '<span class="d-flex align-items-center"><img src="../../../../img/icons/ICONO DESCARGAR2_Mesa de trabajo 1.svg" width="20" class="mr-1"> Descargar inventario costeado</span>',
          className: "btn-custom--white-dark",
          action: function () {
            window.location.href="functions/export_inventarioCosteado.php";
          },
        },
      ],
    },
