  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../include/db-conn.php');
      ...
      if(isset ($_POST['btnEditar'])){
        ...
        $stmt = $conn->prepare('UPDATE puestos set puesto= :puesto, Sueldo_semanal= :sueldo WHERE PKPuesto = :id');
        $stmt->bindValue(':puesto',$puesto);
        $stmt->bindValue(':sueldo',$sueldo);
        $stmt->bindValue(':id', $id, PDO::PARAM_INT);
        $stmt->execute();
          header('Location:../index.php?p1='.$puesto1.'&a=edit&p2='.$puesto.'&s='.$sueldo.'');
...
<head>
  ...
  <title>Timlid | Editar puesto</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Editar puesto</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" maxlength="30" name="txtPuesto" value="<?=$puesto1;?>">
                              </div>
                              <div class="col-lg-6">
                                <label for="usr">Sueldo:</label>
                                <input type="number" class="form-control" maxlength="30" name="txtSueldo" value="<?=$sueldo1;?>">
                              </div>
                            </div>
                          </div>
