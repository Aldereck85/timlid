  ...
  <div class="modal fade" id="mdlsavealert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div id="msj" class="modal-body"><center><h4>¿Deseas <?php echo($accion) ?> </h4></center></div>
        <div class="modal-footer">
          ...
          <a class="btn-custom btn-custom--blue" id="btnAcepCambios">Aceptar</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="mdlnotifi" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn-custom btn-custom--blue" href="" id="btnAcepCambios">Aceptar</a>
        </div>
      </div>
    </div>
  </div>