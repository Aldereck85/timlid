<?php
  ...
  $stmt = $conn->prepare('SELECT * FROM permisos_secciones INNER JOIN secciones ON PKSeccion = FKSeccion WHERE FKUsuario = :id');
                              ...
                              <div id="divRolControl" class="col-lg-12">
                                ...
                                while($row = $stmt->fetch()){
                                  if($row['Permiso'] == 1){
                                    echo '
                                    <div class="card">
                                      <div class="card-header" id="heading'.$z.'">
                                        <h5 class="mb-0">
                                      ...
                                      <div id="collapse'.$z.'" class="collapse" aria-labelledby="heading'.$z.'" data-parent="#accordionExample">
                                        <div class="card-body">';
                                          ...
                                          while($row2 = $stmt2->fetch()){
                                            echo '<div class="row" width="100%"><div width="500px" style="background:black;"><input type="checkbox" name="chkTodo'.$row2['Pantalla'].'" class="chkRh chkEncabezado" id="chkTodo'.$row2['Pantalla'].'"';
                                            ...
                                            while($row3 = $stmt3->fetch()){
                                              echo '<input type="checkbox" name="chkTodo'.$row3['Funcion'].'" class="chkRh chkEncabezado" id="chkTodo'.$row3['Funcion'].'"';
                                              if($row3['Permiso']){echo 'checked';}
                                              echo '>';
                                              echo '&nbsp;<label for="chkTodo'.$row3['Funcion'].'"> '.$row3['Funcion'].'</label>&nbsp;&nbsp;';
                                            }
                                            echo "</div>";
                                          }
                                        echo'</div>
                                  ...
                                  /*array_push($idSeccion, $row['FKSeccion']);
                                  array_push($seccion, $row['Seccion']);
                                  array_push($permitido, $row['Permitido']);
                                  echo $idSeccion[$x];
                                  echo "<br>";
                                  echo $seccion[$x];
                                  echo "<br>";
