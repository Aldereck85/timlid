...
<head>
  ...
  <script src="../../js/clientes_javier.js" charset="utf-8"></script>
</head>
...
<div class="modal fade" id="eliminar_Cliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
    ...
    <div class="modal-content">
      <form action="" method="POST">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" onclick="eliminarCliente();" class="btnesp espAgregar float-right"><span
