...
<head>
  ...
  <title>Timlid | Agregar Orden de Pedido</title>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="cmbVendedor" id="chosenVendedor" required>
                                  ...
                                  ?>
                                  <?php foreach ($stmt as $option): ?>
                                  <option value="<?php echo $option['PKEmpleado']; ?>">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              ...
                              <input type="date" class="form-control" name="txtFechaEntrega"
                                id="txtFechaEntrega" value="<?=date('Y-m-d')?>"  min="<?=date('Y-m-d')?>" required>
...
?>
  ...
  $("#btnAgregar").click(function() {
    ...
    $('#ordenpedido').append("<input type='hidden' name='tabla_ordenpedido'  id='tabla_ordenpedido' value='" +
      ...
      $.ajax({
        type: 'post',
        url: 'functions/ordenpedidoSubmit.php',
