        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" id="actividadTareas">
                    ...
                    <!-- <div class="col-lg-6">
                        <label><input type="checkbox" id="tarea_recurrente" class="mr-1">Agregar tarea recurrente</label>
                    </div> -->
                    <div class="row" id="tarea_con_recurrencia">
                        <div class="col-lg-3">
                            <label id="label_hora_tarea">Tipo recurrencia</label>
                            <select name="" id="">
                        ...
                        <div class="col-lg-3">
                            <label id="label_hora_tarea">Fecha inicio</label>
                            <input type="date" class="form-control alphaNumeric-only">
                        </div>
                        <div class="col-lg-3">
                            <label id="label_hora_tarea">Fecha finalización</label>
                            <input type="date" class="form-control alphaNumeric-only">
                        </div>
                        <div class="col-lg-3">
                            <label id="label_hora_tarea">Comienzo</label>
                            <input type="time" class="form-control alphaNumeric-only">
                        </div>
                    </div>
                </div>
                ...
                <div class="row" id="actividadReuniones">
                    <div class="col-lg-12">
                        ...
                        <select name="empleadoModal" id="empleadoModal" multiple>
                    ...
                    <div class="col-lg-12">
                        <label>Lugar</label>
                        <input type="text" class="form-control alphaNumeric-only" name="lugar" id="lugar_reunion" required>
                    </div>
                    <div class="col-lg-4">
                        <label class="d-block">Fecha</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btnesp first espAgregar" onclick="modificarActividad();" id="editar_actividad_id">Editar <span></span></button>
