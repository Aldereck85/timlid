  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        //echo $id." ".$banco." ".$cuenta." ".$email." ".$cliente;
        try{
        $stmt = $conn->prepare('UPDATE correos_clientes set Email= :email WHERE PKEmail = :id');
      ...
      if(isset($_GET['id'])){
        $id =  $_GET['id'];
        $cliente =  $_GET['cliente'];
        $stmt = $conn->prepare('SELECT * FROM correos_clientes WHERE PKEmail= :id');
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtEmail" value="<?=$email;?>">
                              </div>
