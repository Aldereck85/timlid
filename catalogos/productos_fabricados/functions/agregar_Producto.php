...
if (isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)) {
    ...
    if (isset($_POST['btnAgregar'])) {
        ...
        try {
            $stmt = $conn->prepare('INSERT INTO productos_fabricados (ProductoFabricado)VALUES(:producto)');
...
<head>
  ...
  <title>Timlid | Agregar producto fabricado</title>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-12">
                              ...
                              <input type="text" class="form-control alpha-only" maxlength="30" name="txtProducto">
                            </div>
                          </div>
                        </div>
