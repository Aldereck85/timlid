  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        try{
          $stmt = $conn->prepare('INSERT INTO clientes (Nombre_comercial,FKEstatus,FKUser,FechaAlta,Monto_credito,Dias_credito)VALUES(:nombre,:estatus,:usuario,:fecha,:monto,:dias)');
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-portrait"></i> Agregar Cliente</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtNombre">
                                </div>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-5">
                                ...
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control numericDecimal-only grupoCredito" maxlength="30" name="txtMonto">
                                </div>
                              </div>
                              <div class="col-lg-5">
                                <label for="usr">Días de crédito:</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control numeric-only grupoCredito" maxlength="30" name="txtDias">
                                </div>
                              </div>
                            </div>
                          </div>
