  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        $tipo = $_POST['txtTipoPago'];

        try{
          $stmt = $conn->prepare('INSERT INTO puestos (Puesto, FKTipoPagoNomina)VALUES(:puesto,:tipo)');
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" maxlength="30" name="txtPuesto">
                              </div>
                              <div class="col-lg-6">
                                <label for="usr">Sueldo semanal:</label>
                                <input type="number" class="form-control" maxlength="30" name="txtSueldo">
                              </div>
                            </div>
                          </div>
