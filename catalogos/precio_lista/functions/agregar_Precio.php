...
session_start();
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    ...
    if(isset ($_POST['btnAgregar'])){
      ...
      try{
        $stmt = $conn->prepare('INSERT INTO precio_lista (Precio_Unitario,FKProducto,FKCliente) VALUES (:precio,:producto,:cliente)');
                          ...
                          <div class="form-group">
                            <div class="row">
                                ...
                                <select class="form-control" name="cmbProducto" id="cmbProducto">
                                  ...
                                  <?php
                                    ...
                                    while($row = $stmt->fetch()){
                                      ?>
                                  <option value="<?=$row['PKProducto']; ?>"><?=$row['Descripcion'];?></option>
                                  <?php
                                    }
                                  ?>
                                </select>
                              ...
                              <div class="col-lg-4">
                                ...
                                <input class="form-control numericDecimal-only" type="text" name="txtPrecio" value="">
                              </div>
                            </div>
                          </div>
