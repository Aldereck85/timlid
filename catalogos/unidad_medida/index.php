...
<head>
  ...
  <title>Timlid | Unidades de Medida</title>
  ...
  $(document).ready(function() {
    ...
    $("#tblUnidades").dataTable({
      ...
      "lengthChange": false,
      "info": false,
      "ajax": "functions/function_Unidades.php",
      "columns": [{
          "data": "No"
        },
        {
...
?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Unidades de medida</h1>
          <p class="mb-4">Información general de las unidades de medida</p>
          ...
          <div class="card mb-4">
              ...
              <div class="float-right">
                <div class="button-container2" id="">
                  <div class="button-icon-container">
                    <a href="functions/agregar_Unidades.php"
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table" id="tblUnidades" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Clave SAT</th>
...
?>
  ...
  <div id="eliminar_Unidades" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/eliminar_Unidades.php" method="POST">
          <input type="hidden" name="idUnidadesD" id="idUnidadesD">
          <div class="modal-header">
  ...
  <div id="editar_Unidades" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/editar_Unidades.php" method="POST">
          <input type="hidden" name="idUnidadesU" id="idUnidadesU">
          <div class="modal-header">
  ...
  <script>
  function obtenerIdUnidadesEliminar(id) {
    document.getElementById('idUnidadesD').value = id;
  }

  function obtenerIdUnidadesEditar(id) {
    document.getElementById('idUnidadesU').value = id;
  }
