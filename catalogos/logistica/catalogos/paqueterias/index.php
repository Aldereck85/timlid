...
<head>
  ...
  <title>Timlid | Paqueterías</title>
  ...
  <link href="../../style/paqueterias.css" rel="stylesheet">
  ...
  <script src="../../js/paqueterias.js" charset="utf-8"></script>
...
<div class="modal fade" id="eliminar_Paqueteria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <form action="" method="POST">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="obtenerEliminarPaqueteria()" data-dismiss="modal" class="btn-custom btn-custom--blue">
