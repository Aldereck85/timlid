  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE cuentas_bancarias set FKBanco= :banco,No_de_cuenta= :cuenta, CLABE= :clabe WHERE PKCuenta = :id');
      ...
      if(isset($_GET['id'])){
        $id =  $_GET['id'];
        $cliente =  $_GET['cliente'];
        $stmt = $conn->prepare('SELECT * FROM cuentas_bancarias WHERE PKCuenta= :id AND FKCliente = :cliente');
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtCuenta" value="<?=$cuenta;?>">
                                </div>
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">CLABE:</label>
                                <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtCLABE" value="<?=$clabe;?>">
                              </div>
