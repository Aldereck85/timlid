...
<head>
  ...
  <title>Timlid | Email de paqueteria</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Directorio de emails de la paqueteria</p>
  ...
  <div id="eliminar_EmailPaqueteria" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="funciones/eliminar_Correo.php" method="POST">
          <input type="hidden" name="txtIdP" id="txtIdP">
          <input type="hidden" name="idEmailD" id="idEmailD" value="">
          <div class="modal-header">
  ...
  <div id="editar_EmailPaqueteria" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="funciones/editar_Correo.php" method="POST">
          <input type="hidden" name="idEmailU" id="idEmailU">
          <div class="modal-header">
  ...
  <script>
    function obtenerIdEmailPaqueteriaEliminar(id, paqueteria){
      document.getElementById('idEmailD').value = id;
      document.getElementById('txtIdP').value = paqueteria;
    }
    function obtenerIdEmailPaqueteriaEditar(id){
      document.getElementById('idEmailU').value = id;
    }
