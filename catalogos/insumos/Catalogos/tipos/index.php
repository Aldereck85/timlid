...
<head>
  ...
  <title>Timlid | Tipos de insumo</title>
...
?>
          ...
          <div class="divPageTitle">
            ...
            <label class="lblPageTitle">&nbsp;Tipos de Insumo</label>
          </div>
    ...
    <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
      <div class="modal-content">
        <form action="functions/agregar_Insumo.php" method="POST">
          ...
          <div class="modal-header">
            <h4 class="modal-title w-100" id="myModalLabel">Agregar tipo de insumo</h4>
          ...
          <div class="modal-body">
            <div class="form-group">
              <label for="usr">Nombre del tipo de insumo:</label>
              <input type="text" class="form-control" maxlength="100" id="txtTipo" name="txtTipo"
                placeholder="Escriba aquí el tipo de insumo" required>
            </div>
          </div>
    ...
    <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
      <div class="modal-content">
        <form action="functions/editar_Insumo.php" method="POST">
          ...
          <div class="modal-header">
            <h4 class="modal-title w-100" id="myModalLabel">Editar tipo de insumo</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label for="usr">Nombre del tipo de insumo:</label>
              <input type="text" class="form-control" maxlength="100" id="txtTipoU" name="txtTipoU"
                placeholder="Escriba aquí el tipo de insumo" required>
              <input class="form-control" id="notaEliminarU" type="hidden"
                ...
                value="Nota: Tipo insumo no puede ser eliminado. Existen insumos que pertenecen a esta clasificación."
                readonly>
            </div>
          </div>
          <div class="modal-footer justify-content-center">
      ...
      <div class="modal-content">
        <form action="functions/eliminar_Insumo.php" method="POST">
          ...
          <div>
            ...
            <br>
            <label for="usr" style="margin-left: 80px!important;">Se eliminará el siguiente tipo de insumo:</label>
          </div>
          <div class="row card-body" style="margin-top: -80px!important;">
            ...
            <div class="form-group col-md-8">
              <input type="text" class="form-control" maxlength="100" id="txtTipoD" name="txtTipoD" readonly>
            </div>
          </div>
  ...
  function obtenerIdInsumoEditar(id) {
    ...
    $.ajax({
      ...
      success: function(r) {
        ...
        $("#txtTipoU").val(datos.tipo);

        /* DATOS EN MODAL ELIMINAR */
        $("#txtTipoD").val(datos.tipo);
