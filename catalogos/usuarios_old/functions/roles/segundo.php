                                        ...
                                        <div id="collapse'.$z.'" class="collapse" aria-labelledby="heading'.$z.'" data-parent="#accordionExample">
                                          <div class="card-body">';
                                            ...
                                            while($row2 = $stmt2->fetch()){
                                              ...
                                              echo '<div class="row"><div class="col-lg-12" style="background:#ececec;padding:5px;"><input type="checkbox" name="chkTodo'.$row2['Pantalla'].'" class="chkRh chkPantalla" value="'.$row2['PKPantalla'].'" id="chkTodo'.$numPantalla.'"';
                                              ...
                                              while($row3 = $stmt3->fetch()){
                                                echo '<div class="col-lg-1" style="padding:5px;"><input type="checkbox" name="chk'.$row2['Pantalla'].$row3['Funcion'].'" class="chkRh chkFuncion" id="chkFuncion'.$numFuncion.'"';
                                                $numFuncion++;
