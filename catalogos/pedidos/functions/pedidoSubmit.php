...
if (!empty($_SESSION['token_ld10d'])) {
  if (!hash_equals($_SESSION['token_ld10d'], $token)) {
    ...
    try {
      ...
      $stmt->bindValue(':tipo_pedido', $tipo_pedido);
      ...
      for ($x = 0; $x < $cuenta; $x++) {
        ...
        $stmt = $conn->prepare("INSERT INTO detalle_orden_pedido_por_sucursales (producto_id, cantidad_pedida, orden_pedido_id ) VALUES (:producto_id, :cantidad_pedido, :orden_pedido_id)");
