...
session_start();
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    ...
    if(isset ($_POST['btnAgregar'])){
      ...
      try{
        $stmt = $conn->prepare('INSERT INTO marcas (marca) VALUES (:marca)');
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Agregar marca de productos</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control alpha-only" maxlength="20"  name="txtMarca" required>
                              </div>
                            </div>
                          </div>
