  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        //echo $id." ".$banco." ".$cuenta." ".$telefono." ".$cliente;
        try{
        $stmt = $conn->prepare('UPDATE telefonos_clientes set Telefono= :telefono WHERE PKTelefono = :id');
      ...
      if(isset($_GET['id'])){
        $id =  $_GET['id'];
        $cliente =  $_GET['cliente'];
        $stmt = $conn->prepare('SELECT * FROM telefonos_clientes WHERE PKTelefono= :id');
...
<head>
  ...
  <title>Timlid | Editar Teléfono</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Editar teléfono</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control numeric-only" maxlength="10" name="txtTelefono" value="<?=$telefono;?>">
                              </div>
  ...
  <script>
    $(document).ready(function(){
      $("#alertaTareas").load('../../../../lerta_Tareas_Nuevas.php?user='+<?=$_SESSION['PKUsuario'];?>+'&ruta='+'<?=$ruta;?>');
