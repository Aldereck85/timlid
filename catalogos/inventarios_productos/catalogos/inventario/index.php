...
<head>
  ...
  <title>Timlid | Existencias</title>
...
<body id="page-top" class="sidebar-toggled">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php
        $rutatb = "../../../";
        $icono = 'ICONO-EXISTENCIAS-AZUL.svg';
        $titulo = 'Existencias';
                ...
                <form>
                  <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <select name="" class="form-control" id="categoria_input" onchange="validEmptyInput(this)">
                        <option disabled selected>Selecciona una categoria</option>
                        <option value="todas">Todas</option>
                        <?php foreach ($sucCat as $sucItem) { ?>
                          <option value="<?= $sucItem["PKCategoriaProducto"] ?>"><?= $sucItem["CategoriaProductos"] ?></option>
                        <?php } ?>
                      </select>
                      <div class="invalid-feedback" id="invalid-categoria">
  ...
  <script src="../../js/inventario.js" charset="utf-8"></script>
  <script>
