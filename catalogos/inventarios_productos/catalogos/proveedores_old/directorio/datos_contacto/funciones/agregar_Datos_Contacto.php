    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO datos_contacto_proveedores (Nombre,Apellido_Paterno,Puesto,Telefono,Celular,Email,FKProveedor)VALUES(:nombre,:apellido,:puesto,:telefono,:celular,:email,:proveedor)');
