  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 1 || $_SESSION["FKRol"] == 4)){
    require_once('../../../include/db-conn.php');
      ...
      if(isset($_GET['id'])){
        ...
        $stmt = $conn->prepare('SELECT * FROM servicios WHERE PKServicio= :id');
      ...
      if(isset ($_POST['btnEditar'])){
        ...
        $tipo = $_POST['cmbTipo'];
        try{
        $stmt = $conn->prepare('UPDATE servicios set Servicio= :servicio, Tipo_de_Servicio= :tipo WHERE PKServicio = :id');
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" maxlength="20" name="txtServicio" value="<?=$servicio;?>">
                              </div>
                              <div class="col-lg-6">
                                <label for="usr">Tipo de servicio:</label>
                                <select name="cmbTipo" class="form-control" required>
                                  <option value="" >Elegir opción</option>
                                  <option value="1" <?php if ($tipo == 1 ) echo 'selected'; ?>>Preventivo</option>
                                  <option value="0" <?php if ($tipo == 0 ) echo 'selected'; ?>>Correctivo</option>
                                </select>
                              </div>
                            </div>
                          </div>
