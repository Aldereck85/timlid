  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE domicilio_de_envio set Calle= :calle,Numero_exterior= :numEx,Numero_Interior= :numInt,Colonia= :colonia,Municipio= :municipio,Estado= :estado,CP= :cp,Locacion= :locacion WHERE PKDomicilio = :id');
      ...
      if(isset($_GET['id'])){
        $id =  $_GET['id'];
        $cliente =  $_GET['cliente'];
        $stmt = $conn->prepare('SELECT * FROM domicilio_de_envio WHERE PKDomicilio= :id AND FKCliente = :cliente');
...
<head>
  ...
  <title>Timlid | Editar domicilio de envio</title>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-8">
                                ...
                                <input type="text" class="form-control alpha-only" maxlength="20" name="txtCalle" value="<?=$calle;?>">
                              </div>
                              <div class="col-lg-2">
                                <label for="usr">Número exterior:</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control numeric-only" maxlength="3" name="txtNumeroEx" value="<?=$numEx;?>">
                                </div>
                              </div>
                              <div class="col-lg-2">
                                <label for="usr">Número interior:</label>
                                <input type="text" class="form-control numeric-only" maxlength="30" name="txtNumeroInt" value="<?=$numInt;?>">
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-lg-4">
                                <label for="usr">Colonia:</label>
                                <input type="text" class="form-control alpha-only" maxlength="20" name="txtColonia" value="<?=$colonia;?>">
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Municipio:</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alpha-only" maxlength="20" name="txtMunicipio" value="<?=$municipio;?>">
                                </div>
                              </div>
                              <div class="col-lg-4">
                            ...
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control numeric-only" maxlength="20" name="txtCP" value="<?=$cp;?>">
                              </div>
                              <div class="col-lg-6">
