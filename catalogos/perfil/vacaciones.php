...
<body id="page-top">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="tblVacaciones" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>ID Permiso</th>
                      <th>Empleado</th>
  ...
  <script>
    ...
    $(document).ready(function(){
      $("#alertaVacaciones").load('../alerta_Vacaciones.php?user='+<?=$_SESSION['PKUsuario'];?>+'&ruta='+'<?=$ruta;?>');
        setInterval(refrescar, 5000);
      });
    function refrescar(){
      $("#alertaVacaciones").load('../alerta_Vacaciones.php?user='+<?=$_SESSION['PKUsuario'];?>+'&ruta='+'<?=$ruta;?>');
