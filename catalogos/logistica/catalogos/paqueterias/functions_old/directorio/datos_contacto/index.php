...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Directorio contactos de la paqueteria</p>
  ...
  <div id="eliminar_ContactoPaqueteria" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="funciones/eliminar_Datos_Contacto.php" method="POST">
          <input type="hidden" name="idContactoD" id="idContactoD">
  ...
  <div id="editar_ContactoPaqueteria" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="funciones/editar_Datos_Contacto.php" method="POST">
          <input type="hidden" name="idContactoU" id="idContactoU">
          <div class="modal-header">
  ...
  <script>
    function obtenerIdContactoPaqueteriaEliminar(id, paqueteria){
      document.getElementById('idContactoD').value = id;
      document.getElementById('txtIdP').value = paqueteria;
    }
    function obtenerIdContactoPaqueteriaEditar(id){
      document.getElementById('idContactoU').value = id;
    }
