  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE proveedores set Razon_Social= :razon, Nombre_comercial= :nombre,RFC= :rfc,Calle =:calle,Numero_exterior =:numEx,Numero_Interior =:numInt,Colonia =:colonia,Municipio =:municipio,Estado =:estado,CP =:cp,Dias_Credito= :dias_credito,Limite_Credito= :limite_credito WHERE PKProveedor = :id');
      ...
      if(isset($_POST['idProveedorU'])){
        $id =  $_POST['idProveedorU'];
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtRazon" value="<?=$razon;?>" required>
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Nombre comercial:*</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtNombre" value="<?=$nombre;?>" required>
                                </div>
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">RFC:*</label>
                                <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtRFC" value="<?=$rfc;?>" required>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-lg-3">
                                <label for="usr">Calle:*</label>
                                <input type="text" class="form-control alpha-only" maxlength="30" name="txtCalle" value="<?=$calle;?>" required>
                              </div>
                              <div class="col-lg-3">
                                <label for="usr">Numero exterior:*</label>
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control numeric-only" maxlength="30" name="txtNumeroEx" value="<?=$numEx;?>" required>
                                </div>
                              </div>
                              <div class="col-lg-3">
                                <label for="usr">Numero interior:</label>
                                <input type="text" class="form-control alphaNumeric-only" maxlength="30" name="txtNumeroInt" value="<?=$numInt;?>">
                              </div>
                              <div class="col-lg-3">
                                <label for="usr">Colonia:*</label>
                                <input type="text" class="form-control alpha-only" maxlength="30" name="txtColonia" value="<?=$colonia;?>" required>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-lg-3">
                                ...
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alpha-only" maxlength="30" name="txtMunicipio" value="<?=$municipio;?>" required>
                                </div>
                              </div>
                              <div class="col-lg-3">
                              ...
                              <div class="col-lg-3">
                                ...
                                <input type="text" class="form-control numeric-only" maxlength="30" name="txtCP" value="<?=$cp;?>" required>
                              </div>
                              <div class="col-lg-3">
                                ...
                                <div class="form-check-inline">
                                  <label class="form-check-label"><input type="radio" class="form-check-input" value="No" name="txtCredito" id="txtCredito" required> No </label>
                                </div>
                              </div>
                            </div>
                            <div id="datosCredito">
                              <div class="row">
                                <div class="col-lg-6">
                                  ...
                                  <input class="form-control numeric-only" type="text" name="txtDiasCredito" value="<?=$dias; ?>">
                                </div>
                                <div class="col-lg-6">
                                  <label for="txtLimiteCredito">Limite de credito:</label>
                                  <input class="form-control numericDecimal-only" type="text" name="txtLimiteCredito" value="<?=$limite ?>">
                                </div>
                              </div>
                            </div>
                          </div>
