...
<head>
  ...
  <title>Timlid | Productos fabricados</title>
  ...
  $(document).ready(function() {
    ...
    $("#tblProductos").dataTable({
      ...
      "lengthChange": false,
      "info": false,
      "ajax": "functions/function_Productos_Fabricados.php",
      "columns": [{
          "data": "Producto fabricado"
        },
        {
          "data": "Acciones"
        }
...
?>
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-tshirt"></i> Productos fabricados</h1>
          <p class="mb-4">Información general de los productos que se fabrican</p>
...
?>
  ...
  <div id="eliminar_Producto" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/eliminar_Producto.php" method="POST">
          <input type="hidden" name="idProductoD" id="idProductoD">
          <div class="modal-header">
  ...
  <div id="editar_Producto" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/editar_Producto.php" method="POST">
          <input type="hidden" name="idProductoU" id="idProductoU">
          <div class="modal-header">
  ...
  function obtenerIdProductoEliminar(id) {
    document.getElementById('idProductoD').value = id;
  }

  function obtenerIdProductoEditar(id) {
    document.getElementById('idProductoU').value = id;
  }
