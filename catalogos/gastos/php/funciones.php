        ...
        case "get_data":
            ...
            switch ($_REQUEST['funcion']) {
                ...
                case "get_cmb_categorias_gasto":
                    ...
                    return;
                    break;
                case "get_cmb_subcategorias_gasto":
                    $categoria = $_REQUEST['data'];
                    $json = $data->getCmbSubcategoriaG($categoria);
                    echo json_encode($json);
                    return;
                    break;
                case "get_categoriesTotals":
                    $json = $data->getCategoriesTotals();
                    echo json_encode($json);
                    return;
                break;
                case "get_subcategoriesTotals":
                    $json = $data->getSubCategoriesTotals();
                    echo json_encode($json);
                    return;
                break;
                case "get_categorias":
                ...
                case "get_subcategorias":
                    ...
                    return;
                break;
                case "get_listCategorySubcategory":
                    $json = $data->getListCategorySubcategory();
                    echo json_encode($json); //Retornando el resultado al ajax
                    return;
                break;
                case "get_listCategorySubcategoryFilter":
                    $cuenta = $_REQUEST['cuenta'];
                    $categoria = $_REQUEST['categoria'];
                    $subcategoria = $_REQUEST['subcategoria'];
                    $fecha_inicial = $_REQUEST['fecha_inicial'];
                    $fecha_final = $_REQUEST['fecha_final'];
                    $json = $data->getListCategorySubcategoryFilter($cuenta,$categoria,$subcategoria,$fecha_inicial,$fecha_final);
                    echo json_encode($json); //Retornando el resultado al ajax
                    return;
                break;
            }
