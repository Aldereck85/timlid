...
<head>
  ...
  <title>Timlid | Categorias de productos</title>
  ...
  $(document).ready(function() {
    ...
    $("#tblCategorias").dataTable({
        ...
        "lengthChange": false,
        "info": false,
        "ajax": "functions/function_Categoria.php",
        "columns": [{
            "data": "No"
          },
          {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Información general de las categorias de productos</p>
          ...
          <div class="card mb-4">
              ...
              <div class="float-right">
                <div class="button-container2" id="">
                  <div class="button-icon-container">
                    <a href="functions/agregar_Categoria.php"
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table" id="tblCategorias" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Categoria</th>
...
?>
  ...
  <div id="eliminar_Categoria" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/eliminar_Categoria.php" method="POST">
          <input type="hidden" name="idCategoriaD" id="idCategoriaD">
          <div class="modal-header">
  ...
  <div id="editar_Categoria" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="functions/editar_Categoria.php" method="POST">
  ...
  <script>
  function obtenerIdCategoriaEliminar(id) {
