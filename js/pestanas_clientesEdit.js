...
function CargarDatosCliente(id) {
  validate_Permissions(10,1,id);

  resetTabs("#CargarDatosEdicionCliente");
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="formDatosCliente"> 
                        <div class="form-group" id="btnDeletePermissions">
                          <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-5 col-xs-6">
                              <input type="checkbox" id="active-cliente" class="check-custom">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtNombreComercial" id="txtNombreComercial" required maxlength="255" placeholder="Ej. GH Medic" onkeyup="escribirNombre()" style="text-transform: uppercase">
                            ...
                            <div class="col-lg-3">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  ...
                                  <img  id="notaFTelefono" name="notaFTelefono" style="display: none;"
                          ...
                          <div class="row">
                            <div class="col-lg-2">
                              ...
                              <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="flexSwitchCheckDefault">Activar crédito</label>
                              </div>
                            </div>
                        ...
                        <input type="hidden" id="txtNombreComercialHis" value="">
...
function cargarCMBMedioContactoCliente(data, input) {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      console.log("respuesta medios de contactosss: ", respuesta);

      //fhtml += '<option data-placeholder="true"></option>';
...
function cargarCMBRegimen(data, input) {
  var html = "";
  $.ajax({
    url: "../../php/funciones.php",
...
$(document).on("click", "#btnEditarCliente", function () {
  if ($("#formDatosCliente")[0].checkValidity()) {
    ...
    if (
      ...
      var pkCliente = $("#txtPKCliente").val();
      ...
      //var estatus = $("#cmbEstatusCliente").val();
...
/*         datos12: razonSocial,
        ...
        success: function (respuesta) {
          ...
          if (respuesta[0].status) {
            Lobibox.notify("success", {
              ...
              msg: "¡Datos generales actualizados correctamente!",
              sound: '../../../../../sounds/sound4'
            });
          } else {
  ...
  SeguirDatosFiscales(pkCliente);
});

function regresarDatosCliente(id) {
...
function validarCP() {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      if (!ercp.test(value) || respuesta == false) {
        $("#invalid-cp").css("display", "block");
...
function anadirRazonSocial(id) {
  if (!$("#txtRFC").val() || !$("#txtRazonSocial").val() || !$("#txtCP").val() || !$("#cmbPais").val() || !$("#cmbEstado").val()) {
    ...
    $.ajax({
      ...
      data: {
        clase: "edit_data",
        funcion: "edit_razonSocial_Cliente",
        datos: razonSocial,
        datos2: rfc,
        datos4: calle,
        datos5: numExt,
                      ...
                      <form id="formDatosContacto"> 
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtNombreContacto" id="txtNombreContacto" onkeyup="validEmptyInput('txtNombreContacto', 'invalid-nombreCont', 'El contacto debe tener un nombre.')" required maxlength="50" placeholder="Ej. José María">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  ...
                                  <img  id="notaFApellidoContacto" name="notaFApellidoContacto" style="display: none;"
                                  src="../../../../img/timdesk/alerta.svg" width=30px
                                  title="Campo requerido" readonly>
                                </div>
                              </div>
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  ...
                                  <img  id="notaFPuesto" name="notaFPuesto" style="display: none;"
                                  src="../../../../img/timdesk/alerta.svg" width=30px
                                  title="Campo requerido" readonly>
                                </div>
                              </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control numeric-only" type="text" name="txtTelefono" id="txtTelefono" autofocus="" maxlength="10" placeholder="Ej. 33 3333 3333">                   
                                  <img  id="notaFTelefono" name="notaFTelefono" style="display: none;"
                                  src="../../../../img/timdesk/alerta.svg" width=30px
                                  title="Campo requerido" readonly>
                                </div>
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control numeric-only" type="text" name="txtCelular" id="txtCelular" autofocus="" maxlength="10" placeholder="Ej. 33 3333 3333">
                                  <img  id="notaFCelular" name="notaFCelular" style="display: none;"
                                  src="../../../../img/timdesk/alerta.svg" width=30px
                                  title="Campo requerido" readonly>
                                </div>
                              </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-3 d-flex justify-content-end" id="btnAnadirContacto2">
...
/* Eliminamos los invalid divs al cerrar el modal */
...
function guardarDatosContacto(id) {
  Lobibox.notify("success", {
    ...
    icon: true,
    img: "../../../../img/timdesk/checkmark.svg",
    msg: "¡Los datos de contacto del cliente fueron agregados con éxito!",
    sound: '../../../../../sounds/sound4'
  });
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-3">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control numeric-only" type="text" minlength="10" maxlength="20" name="txtNoCuenta" id="txtNoCuenta" min="0" autofocus="" placeholder="Ej. 0000000000" onkeyup="validarNoCuenta()">
...
function validarNoCuentaEditModal() {
  ...
  console.log("cuenta:", noCuenta, "cuentaOld:", cuentaOld);
...
function guardarDatosBancarios(id) {
  ...
  Lobibox.notify("success", {
    ...
    icon: true,
    img: "../../../../img/timdesk/checkmark.svg",
    msg: "¡Los datos bancarios del cliente fueron agregados con éxito!",
    sound: '../../../../../sounds/sound4'
  });
}

function SeguirListadoProductos(id) {
  validate_Permissions(10,4,id);

  validarEmpresaCliente(id);
  resetTabs("#CargarEdicionListadoProductos");
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control numericDecimal-only" type="text" name="txtCostoEspecialVenta" id="txtCostoEspecialVenta" autofocus="" maxlength="13" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required="" placeholder="Ej. 10.00" onkeyup="validEmptyInput('txtCostoEspecialVenta', 'invalid-costoProd', 'El producto debe tener un costo.')">
                            ...
                            <div class="col-lg-4 d-flex justify-content-end align-items-end" id="btnAnadirCliente2">
                               
                            </div>
                            <label class="mt-3">* Campos requeridos</label>
                          </div>
                        </div>
                        <br>
      ...
      success: function (respuesta) {
        ...
        if (respuesta[0].status) {
          ...
          Lobibox.notify("success", {
            ...
            icon: true,
            img: "../../../../img/timdesk/checkmark.svg",
            msg: "¡Se guardó el producto con éxito!",
            sound: '../../../../../sounds/sound4'
          });
        } else {
          Lobibox.notify("error", {
...
function eliminarProducto(producto) {
  //var producto = document.getElementById('txthideidproduct').value;
...
function guardarDatosListadoProductos(id) {
  ...
  Lobibox.notify("success", {
    ...
    icon: true,
    img: "../../../../img/timdesk/checkmark.svg",
    msg: "¡Los datos de precios especiales para productos fueron agregados con éxito!",
    sound: '../../../../../sounds/sound4'
  });
}

function SeguirDireccionesEnvio(id) {
  validate_Permissions(10,5,id);

  validarEmpresaCliente(id);
  resetTabs("#CargarEdicionDireccionesEnvio");
  cargarCMBPaisesDir("146", "cmbPais");
  cargarCMBEstadosDir("146", "cmbEstado");
                      ...
                      <form id="formDatosFiscales"> 
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtSucursal" id="txtSucursal" autofocus="" required="" maxlength="255" placeholder="Ej. Nogales" onkeyup="escribirSucursal(${id})">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  ...
                                  <img  id="notaFContacto" name="notaFContacto" style="display: none;"
                                  src="../../../../img/timdesk/alerta.svg" width=30px
                                  title="Campo requerido" readonly>
                                </div>
                              </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="email" name="txtEmail" id="txtEmail" autofocus="" required="" maxlength="100" placeholder="Ej. ejemplo@dominio.com" onkeyup="validarCorreoDire(this.value)">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtCalle" id="txtCalle" autofocus="" required="" maxlength="255" placeholder="Ej. Av. México" onkeyup="validEmptyInput('txtCalle', 'invalid-calleDire', 'La dirección debe tener una calle.')">
                            ...
                            <div class="col-lg-2">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control alphaNumeric-only" type="text" name="txtNumExt" id="txtNumExt" autofocus="" required="" maxlength="100" placeholder="Ej. 2353 A" onkeyup="validEmptyInput('txtNumExt', 'invalid-numExt', 'La dirección debe tener un número exterior.')">
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-3">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtColonia" id="txtColonia" autofocus="" required="" maxlength="255" placeholder="Ej. Los Agaves" onkeyup="validEmptyInput('txtColonia', 'invalid-colonia', 'La dirección debe tener una colonia.')">
                            ...
                            <div class="col-lg-3">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtMunicipio" id="txtMunicipio" autofocus="" required="" maxlength="255" placeholder="Ej. Guadalajara" onkeyup="validEmptyInput('txtMunicipio', 'invalid-municipioDire', 'La direccion debe tener un municipio.')">
                            ...
                            <div class="col-lg-2">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control numeric-only" type="text" name="txtCP" id="txtCP" autofocus="" required="" maxlength="5" placeholder="Ej. 52632" onkeyup="validarCPEdit()">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-3 d-flex justify-content-end" id="btnAnadirProveedor2">
        ...
        success: function (respuesta) {
          ...
          if (respuesta[0].status) {
            if(respuesta[0].status == 0){
              ...
              $("#tblListadoDatosDireccionesEnvioProveedor")
                .DataTable()
                .ajax.reload();
              $("#txtSucursal").val("");
              $("#txtEmail").val("");
...
function obtenerIdDireccionProveedorEditar(pkDireccionEnvio) {
  ...
  $.ajax({
    ...
    dataType: "json",
    success: function (respuesta) {
      console.log("respuesta datos de la direccion del proveedor", respuesta);
      ...
      $("#txtNombreDDir").val(respuesta[0].Sucursal);
    ...
    success: function(data) {
      ...
      if (pestana == '1'){
        ...
        if (_permissions.edit == '1') {
          html = `<a href="#" class="float-right btn-custom btn-custom--blue" id="btnEditarCliente">Guardar</a>`;
          $("#btnEditarCliente2").html(html);

          $("#txtNombreComercial").removeClass("readNotEditPermissions");
          $("#txtNombreComercial").addClass("readEditPermissions");

          $("#cmbMedioContactoCliente").removeClass("readNotEditPermissions");
          $("#cmbMedioContactoCliente").addClass("readEditPermissions");
          ...
          $("#cmbMedioContactoCliente").removeClass("readEditPermissions");
          $("#cmbMedioContactoCliente").addClass("readNotEditPermissions");
      ...
      if (pestana == '2'){
        var html = ``;
        if (_permissions.edit == '1') {
          var html = `<a href="#" class="btn-custom btn-custom--blue" id="btnAnadirContacto" onclick="validarContacto(` + id + `)">Guardar Contacto</a>  `;
          ...
          $("#cbxFacturacion").removeClass("readNotEditPermissions");
          $("#cbxFacturacion").addClass("readEditPermissions");

          $("#cbxComplementoPago").removeClass("readNotEditPermissions");
          $("#cbxComplementoPago").addClass("readEditPermissions");

          $("#cbxAvisosEnvio").removeClass("readNotEditPermissions");
          $("#cbxAvisosEnvio").addClass("readEditPermissions");

          $("#cbxPagos").removeClass("readNotEditPermissions");
          $("#cbxPagos").addClass("readEditPermissions");
        }else{
          var html = ``;
          $("#btnAnadirContacto2").html(html);
          ...
          $("#cbxFacturacion").removeClass("readEditPermissions");
          $("#cbxFacturacion").addClass("readNotEditPermissions");

          $("#cbxComplementoPago").removeClass("readEditPermissions");
          $("#cbxComplementoPago").addClass("readNotEditPermissions");

          $("#cbxAvisosEnvio").removeClass("readEditPermissions");
          $("#cbxAvisosEnvio").addClass("readNotEditPermissions");

          $("#cbxPagos").removeClass("readEditPermissions");
          $("#cbxPagos").addClass("readNotEditPermissions");
        } 
      ...
      if (pestana == '3'){
        var html = ``;
        if (_permissions.edit == '1'){
          var html = `<a href="#" class="btn-custom btn-custom--blue" id="btnAnadirContacto" onclick="validarBanco(` + id + `)">Guardar Cuenta Bancaria</a>  `;
          $("#btnAnadirContacto2").html(html);
      ...
      if (pestana == '4'){
        var html = ``;
        if (_permissions.edit == '1'){
          var html = `<a href="#" class="btn-custom btn-custom--blue" id="btnAnadirCliente" onclick="validarClienteProducto(` + id + `)">Añadir precio especial</a> `;
          ...
          $("#cmbProductosCliente").removeClass("readNotEditPermissions");
          $("#cmbProductosCliente").addClass("readEditPermissions");
          ...
          $("#cmbProductosCliente").removeClass("readEditPermissions");
          $("#cmbProductosCliente").addClass("readNotEditPermissions");
      ...
      if (pestana == '5'){
        var html = ``;
        if (_permissions.edit == '1'){
          var html = `<a href="#" class="btn-custom btn-custom--blue" id="btnAnadirProveedor" onclick="anadirRazonSocialDir(` + id + `)">Guardar Dirección de envío</a> `;
          $("#btnAnadirProveedor2").html(html);

          $("#txtSucursal").removeClass("readNotEditPermissions");
          $("#txtSucursal").addClass("readEditPermissions");

          $("#txtContacto").removeClass("readNotEditPermissions");
          $("#txtContacto").addClass("readEditPermissions");
          ...
          $("#txtSucursal").removeClass("readEditPermissions");
          $("#txtSucursal").addClass("readNotEditPermissions");

          $("#txtContacto").removeClass("readEditPermissions");
          $("#txtContacto").addClass("readNotEditPermissions");
