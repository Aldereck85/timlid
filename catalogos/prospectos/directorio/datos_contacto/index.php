...
<head>
  ...
  <script>
    $(document).ready(function(){
      ...
      var id = $("#txtId").val();
      $("#divAgregar").html('<a href="funciones/agregar_Datos_Contacto.php?id='+id+'" class="btn btn-success btn-circle float-right" ><i class="fas fa-plus"></i></a>');
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Directorio contactos del cliente</p>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table stripe" id="tblDatosContacto" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>Nombre</th>
                      <th>Apellido</th>
