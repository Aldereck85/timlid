  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE rollos set Gramos= :gramos, Largo= :largo, Ancho =:ancho, Area =:area WHERE PKRollo = :id');
      ...
      if(isset($_POST['idRolloU'])){
        $id =  $_POST['idRolloU'];
        $stmt = $conn->prepare('SELECT * FROM rollos WHERE PKRollo= :id');
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Editar rollo</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control numeric-only" maxlength="30" name="txtGramos" value="<?=$gramos;?>">
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Largo(mts):</label>
                                <input type="text" class="form-control numericDecimal-only" maxlength="30" name="txtLargo" value="<?=$largo;?>">
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Ancho(mts):</label>
                                <input type="text" class="form-control numericDecimal-only" maxlength="30" name="txtAncho" value="<?=$ancho;?>">
                              </div>
                            </div>
                          </div>
