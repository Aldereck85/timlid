        ...
        if (in_array($excelfile['type'], $allowedFileType)) {
            ...
            if ($excelfile['type'] == "application/vnd.ms-excel" || $extension[1] == "xls") {
                ...
                foreach ($xls->rows() as $campo) {
                    if (trim($campo[0]) == '' && trim($campo[1]) == '' && trim($campo[2]) == '' && trim($campo[3]) == '' && trim($campo[4]) == '' && trim($campo[5]) == '' && trim($campo[6]) == '') {
                                ...
                                if($count2 > 1 && trim($campo[3]) != ''){
                                    ...
                                    foreach($datos as $data){
                                        ...
                                        if (trim($campo[0]) == $data['ClaveInterna']  && trim($campo[4]) == '') {
                                            ...
                                            ++$contadorClaves;
                                        }else if(trim($campo[0]) == $data['ClaveInterna'] && $data['lote'] == 1 && trim($campo[5]) == ''){
                                            $arrayClaves[$contadorClaves] = trim($campo[0]);
                                            ++$contadorClaves;
                                        }else if(trim($campo[0]) == $data['ClaveInterna'] && $data['fecha_caducidad'] == 1 && trim($campo[6]) == ''){
                                            $arrayClaves[$contadorClaves] = trim($campo[0]);
                                            ++$contadorClaves;
                                        } 
                                    }
                                    ...
                                    foreach($datos as $data){
                                        if (trim($campo[0]) == $data['ClaveInterna']) {
                                            ...
                                            if(trim($campo[4]) != ''){
                                                ...
                                                $array[$count4] = $valor;
                                            }else if($data['lote'] == 1 && trim($campo[5]) != ''){
                                                $valor = trim($campo[0]) . "_" . trim($campo[5]);
                                                $array[$count4] = $valor;
                        ...
                        switch([$ignorarFila1, $ignorarFila2]){
                            case [1, 1]:
                                if($count5 > 1 && trim($campo[3]) != ''){
                                    $datos = validar();
                                    foreach($datos as $data){
                                        if(trim($campo[0]) == $data['ClaveInterna'] && $data['fecha_caducidad'] == 1 && date_parse(trim($campo[6]))["year"] == false && trim($campo[6]) != '') {
