...
<head>
    ...
    <link href="../../style/cambio_lote_detalle.css" rel="stylesheet">
    <!-- JS -->
    ...
    <script src="../../js/cambio_lote_detalle.js" charset="utf-8"></script>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <input type="hidden" id="inputCambio">
                <input type="hidden" id="inputTipoCambio" value="<?= $_REQUEST['data2']; ?>">
                <input type="hidden" id="inputFolioCambio">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" id="rowTabla">
                                        <div class="col">
                                            <div class="table-responsive">
                                                <table class="table" id="tblCambiosDetalle" class="display" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr>
                                    ...
                                    <div class="row mt-n5">
                                        ...
                                        <div class="col d-flex justify-content-end align-items-end mt-n5">
                                            <button class="btn-custom btn-custom--blue" id="btnCambiar" onclick="gif()">Guardar</button>
                                        </div>
                                    </div>
