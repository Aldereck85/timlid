  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE productos_fabricados set ProductoFabricado= :producto WHERE PKProductoFabricado = :id');
      ...
      if(isset($_POST['idProductoU'])){
        ...
        $row = $stmt->fetch();
        $producto = $row['ProductoFabricado'];
      }
  }else {
...
<head>
  ...
  <title>Timlid | Editar producto fabricado</title>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header">
                  Tarjeta del producto fabricado
                </div>
                <div class="card-body">
                    <div class="row">
                      <div class="col-lg-12">
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control alpha-only" maxlength="30" name="txtProducto" value="<?=$producto;?>">
                              </div>
                            </div>
                          </div>
