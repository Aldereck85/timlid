...
<body id="page-top" class="sidebar-toggled">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        ...
                                        <h5 class="header-title-screen">RFC: &nbsp; <span class="text-secondary rfc"></span></h5>
                                        </h5>
    ...
    <script src="js/cliente_calendario.js"></script>
    <script src="js/funcionalidades_calendar_cliente.js"></script>
</body>
