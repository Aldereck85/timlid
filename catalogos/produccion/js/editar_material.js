...
{
  deleteDatosProductoCompTempAll(id);
  $.ajax({
    url: "../../php/funciones.php",
...
function deleteDatosProductoCompTempAll(id)
{

  $.ajax({
    url: "../../php/funciones.php",
    data: { clase: "delete_data", funcion: "delete_datosProductoCompTempAll" },
    dataType: "json",
  ...
  saveDatosProductoCompTempAll(id);
}

function saveDatosProductoCompTempAll(id)
{

  $.ajax({
    url: "../../php/funciones.php",
    data: { clase: "save_data", funcion: "save_datosProductoCompTempAll", datos: id },
    dataType: "json",
    success: function (respuesta) {
      console.log(respuesta);
    },
          ...
          body2 =
            ...
            `<tr>
              ...
              <td>
                <div class="row">
                  <div class="col-lg-6">
                    <input class="form-control" type="number" name="txtCantidadCompuesta1" id="txtCantidadCompuesta1" min="0" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" autofocus="" required="" placeholder="Ej. 10" onkeyup="guardarCantidadProdCompTemp(1)" value="${dato.Cantidad}" step="0.01">
                  </div>
                  <div class="col-lg-6">
          ...
          body2 =
            ...
            `<tr>
              ...
              <td>
                <div class="row">
                  <div class="col-lg-6">
                    <input class="form-control" type="number" name="txtCantidadCompuesta${contador}" id="txtCantidadCompuesta${contador}" min="0" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" autofocus="" required="" placeholder="Ej. 10" onkeyup="guardarCantidadProdCompTemp(${contador})" value="${dato.Cantidad}" step="0.01">
                  </div>
                  <div class="col-lg-6">
...
function cargarCompuestosEmp(id) {

  $.ajax({
    url: "../../php/funciones.php",
    data: {
      clase: "get_data",
      funcion: "get_DataDatosEmpaqueCompuesto",
      data: id
    },
    dataType: "json",
    success: function (data) {
      ...
      for (var dato of data) {
        ...
        if (parseInt(contador) == 1) {
          body2 =
            ...
            `<tr>
              <td>
                <input  name="txtProductosEmp1" id="txtProductosEmp1" type="hidden" readonly value="${dato.FKProductoCompuesto}">
                <input type="text" class="form-control" name="cmbProductosEmp1" id="cmbProductosEmp1" data-toggle="modal" data-target="#agregar_Empaque" 
                placeholder="Seleccione un empaque..." readonly required="" onclick="clickSeleccionarEmp(1)" value="${nombre}">
                <img  id="notaFEmpComp" name="notaFEmpComp" style="display: none;"
                src="../../../../img/timdesk/alerta.svg" width=30px
                title="Seleccione por lo menos un empaque" readonly>
              </td>
              <td>
                <div class="row">
                  <div class="col-lg-6">
                    <input class="form-control" type="number" name="txtCantidadCompuestaEmp1" id="txtCantidadCompuestaEmp1" min="0" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" autofocus="" required="" placeholder="Ej. 10" onkeyup="guardarCantidadEmpCompTemp(1)" value="${dato.Cantidad}" step="0.01">
                  </div>
                  <div class="col-lg-6">
                    <label  for="usr" data-toggle="modal" data-target="#agregar_UnidadSAT" onclick="cargarUnidadesSat(1)"><span id="lblUnidadMedidaEmp1">${unidadMedida}</span></label>
                  </div>
                </div>
              </td>
              <td>
                <div class="row">
                  <div class="col-lg-12 input-group">
                    <div class="row">
                      <div class="col-lg-6">
                        <label  for="usr"><span id="lblCostoEmp1" hidden> </span><input class="form-control" type="text" id="txtCostoEmp1" value="${dato.Costo}" onkeyup="guardarCostoEmpCompTemp(1)" required></label>
                      </div>  
                      <div class="col-lg-6"> 
                        <select id="txtMonedaEmp1" onchange="guardarMonedaEmpCompTemp(1)"></select>
                      </div>  
                    </div>  
                  </div>
                </div>
              ...
              <td>
                <input class="form-control" type="number" id="txtColectivas1" onkeyup="guardarColectivosEmpCompTemp(1)" value="${dato.colectivos}" required>
              </td>
              <td>
                *
              </td>
          ...
          body2 =
            ...
            `<tr>
              <td>
                <input  name="txtProductosEmp${contador}" id="txtProductosEmp${contador}" type="hidden" readonly value="${dato.FKProductoCompuesto}">
                <input type="text" class="form-control" name="cmbProductosEmp${contador}" id="cmbProductosEmp${contador}" data-toggle="modal" data-target="#agregar_Empaque" 
                placeholder="Seleccione un empaque..." readonly required="" onclick="clickSeleccionarEmp(${contador})" value="${nombre}">
                <img  id="notaFProdComp" name="notaFProdComp" style="display: none;"
                src="../../../../img/timdesk/alerta.svg" width=30px
                title="Seleccione por lo menos un empaque" readonly>
              </td>
              <td>
                <div class="row">
                  <div class="col-lg-6">
                    <input class="form-control" type="number" name="txtCantidadCompuestaEmp${contador}" id="txtCantidadCompuestaEmp${contador}" min="0" maxlength="12" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" autofocus="" required="" placeholder="Ej. 10" onkeyup="guardarCantidadEmpCompTemp(${contador})" value="${dato.Cantidad}" step="0.01">
                  </div>
                  <div class="col-lg-6">
                    <label  for="usr" data-toggle="modal" data-target="#agregar_UnidadSAT" onclick="cargarUnidadesSat(${contador})"><span id="lblUnidadMedidaEmp${contador}">${unidadMedida}</span></label>
                  </div>
                </div>
              </td>
              <td>
                <div class="row">
                  <div class="col-lg-12 input-group">
                    <div class="row">
                      <div class="col-lg-6">
                        <label  for="usr"><span id="lblCostoEmp${contador}" hidden> </span><input class="form-control" type="text" id="txtCostoEmp${contador}" value="${dato.Costo}" onkeyup="guardarCostoEmpCompTemp(${contador})" required></label>
                      </div>
                      <div class="col-lg-6">
                        <select id="txtMonedaEmp${contador}" onchange="guardarMonedaEmpCompTemp(${contador})"></select>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <td>
                <input class="form-control" type="number" id="txtColectivas${contador}" onkeyup="guardarColectivosEmpCompTemp(${contador})" value="${dato.colectivos}" required>
              </td>
              <td>
                <i><img class=\"btnEdit\" src=\"../../../../img/timdesk/delete.svg\" onclick="eliminarCompTempEmp(${contador}); event.preventDefault(); $(this).closest('tr').remove(); "></i>
              </td>
            </tr>`;
        }

        _global.slims += `cargarCMBMoneda(${dato.FKTipoMoneda},'txtMonedaEmp${contador}');

        new SlimSelect({
          select: '#txtMonedaEmp${contador}',
          deselectLabel: '<span class="">✖</span>',
        });`;
      ...
      var body =
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-lg-12">
                        <label for="usr">Empaques del producto:</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <!-- DataTales Example -->
                    <div class="card-body" id="tablaCompuestoEmp" name="tablaCompuestoEmp">
                      <div class="table-responsive">
                  ...
                  <div class="form-group" id="anadirCompuestoEmp" name="anadirCompuestoEmp">
                    <i><img  src=\"../../../../img/timdesk/ICONO AGREGAR2_Mesa de trabajo 1.svg\" onclick="agregarFilaEmp()" width="30px">  </i>
                    <label>  Añadir empaque</label>
                  </div>`;
      $("#areaCompuestoEmp").html(body);
      cargarCMBEmpaques(id);
    ...
    $.ajax({
      ...
      success: function (respuesta) {
        ...
        if (respuesta[0].status) {
          ...
          deleteDatosProductoCompTempAll();
