  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE datos_contacto set Nombre= :nombre,Apellido_Paterno= :apellido,Puesto= :puesto,Telefono= :telefono,Extencion = :extencion,Celular= :celular,Email= :email WHERE PKContacto = :id');
      ...
      if(isset($_GET['id'])){
        $id =  $_GET['id'];
        $cliente =  $_GET['cliente'];
        $stmt = $conn->prepare('SELECT * FROM datos_contacto WHERE PKContacto= :id');
                          ...
                          <div class="form-group">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3">
                                ...
                                <input type="text" class="form-control numeric-only" maxlength="4" name="txtExtencion" value="<?=$extencion;?>" required>
                              </div>
                              <div class="col-lg-3">
