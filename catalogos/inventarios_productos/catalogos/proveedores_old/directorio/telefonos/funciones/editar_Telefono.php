  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        $id = $_POST['txtIdTelefono'];
        $proveedor = $_POST['txtIdProveedor'];
        $telefono = $_POST['txtTelefono'];
        try{
        $stmt = $conn->prepare('UPDATE telefonos_proveedores set Telefono= :telefono WHERE PKTelefono_Proveedor = :id');
      ...
      if(isset($_POST['txtIdTelefonoU'])){
        $id =  $_POST['txtIdTelefonoU'];
        $stmt = $conn->prepare('SELECT * FROM telefonos_proveedores WHERE PKTelefono_Proveedor= :id');
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <form action="" method="post">
                          <input type="hidden" name="txtIdTelefono" value="<?=$id; ?>">
