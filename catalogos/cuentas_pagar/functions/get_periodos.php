...
if($consulta == 0){
   ...
   Where (DATEDIFF(SYSDATE(), fecha_vencimiento) >= 0) and pr.empresa_id = $empresa and estatus_factura != 5 and cp.estatus_factura!=7 Group By proveedor_id
...
while (($row = $stmt->fetch()) !== false) {
    ...
    if($row['60']==""){
        $row['60']="$0.00";
        $enlace60 = '<a id=\"edit_btn_30\" class=\"disabled\" title=\"Editar datos\" > '.$row['60'].' </a>';
    ...
    if($row['30']==""){
        $row['30']="$0.00";
        $enlace30 = '<a id=\"edit_btn_30\" class=\"disabled\" title=\"Editar datos\" > '.$row['30'].' </a>';
    }else{
    ...
    if($row['90']==""){
        $row['90']="$0.00";
        $enlace90 = '<a id=\"edit_btn_30\" class=\"disabled\" title=\"Editar datos\" > '.$row['90'].' </a>';
    ...
    if($row['+90']==""){
        $row['+90']="$0.00";
        $enlace00 = '<a id=\"edit_btn_30\" class=\"disabled\" title=\"Editar datos\" > '.$row['+90'].' </a>';
