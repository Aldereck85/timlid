                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <a class="btn-custom btn-custom--blue float-right" id="btnAgregarPaqueteria">Continuar</a>
                    </div>
                  </div>
                </div>
              </div>`;
...
$(document).on("click", "#btnAgregarPaqueteria", function () {
      ...
      $.ajax({
        ...
        success: function (respuesta) {
          if (respuesta[0].status) {
            ...
            SeguirDatosContacto(respuesta[0].id);
          } else {
            Lobibox.notify("error", {
              size: "mini",
              rounded: true,
                      ...
                      <form id="formDatosContacto"> 
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-2" style="text-align:center!important; margin-top:35px;">
                              <a href="#" class="btn-custom btn-custom--blue float-right" id="btnContinuarCuentasBancarias">Continuar </a>
                            </div>
                          </div>
                        </div>
                      ...
                      <form id="formDatosCuentasBancarias"> 
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-2" style="text-align:center!important; margin-top:35px;">
                              <a href="#" class="btn-custom btn-custom--blue float-right" id="btnContinuarSucursales">Continuar </a>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
