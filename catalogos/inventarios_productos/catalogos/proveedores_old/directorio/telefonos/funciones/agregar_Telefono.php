    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO telefonos_proveedores (Telefono,FKProveedor)VALUES(:telefono,:proveedor)');
...
<head>
  ...
  <title>Timlid | Agregar teléfono</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Agregar numero de teléfono</h1>
          </div>
