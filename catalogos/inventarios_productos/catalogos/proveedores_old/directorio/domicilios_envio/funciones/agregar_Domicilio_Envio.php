    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO domicilio_de_envio_proveedores (Calle,Numero_exterior,Numero_Interior,Colonia,Municipio,Estado,CP,Locacion,FKProveedor)VALUES(:calle,:numEx,:numInt,:colonia,:municipio,:estado,:cp,:locacion,:fkproveedor)');
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-lg-8">
                                ...
                                <input type="text" class="form-control alpha-only" maxlength="50" name="txtCalle" required>
                              </div>
                              <div class="col-lg-2">
