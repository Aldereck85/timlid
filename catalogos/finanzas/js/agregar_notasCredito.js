...
$(document).ready(function(){
    ...
    cargarCMBTipoGral("", "cmbTipoGral");

    $('#agregar_Producto').on('shown.bs.modal', cargarTablaProductosDevolucion);
});

$(document).on("change", "#cmbTipoGral", function () {
  var tipoGral = $("#cmbTipoGral").val();
  ...
  if (tipoGral == 1){
              ...
              <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                  <div class="providers-disabled">
                    ...
                    <div class="row">
                      <div class="col-lg-12 input-group">
                        <select name="cmbCuentaPagar" id="cmbCuentaPagar" required onchange="validEmptyInput('cmbCuentaPagar', 'invalid-cuentaPagar', 'La nota debe de tener una cuenta por pagar.')">
              ...
              <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                  <div class="providers-disabled">
                    ...
                    <div class="row">
                      <div class="col-lg-12 input-group">
                        <select name="cmbTipoNota" id="cmbTipoNota" required>
    ...
    html2 = `<a class="btn-custom btn-custom--blue float-right" id="btnAgregarNotaCredito">Agregar</a>`;
    ...
    cargarCMBTipoNota("", "cmbTipoNota");
    cargarCMBCuentaPagar("", "cmbCuentaPagar");
    ...
    html = `<div class="form-group">
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-6">
                  ...
                  <div class="row">
                    <div class="col-lg-12 input-group">
                      <select name="cmbProveedorCant" id="cmbProveedorCant" required>
    ...
    cargarCMBProveedorDevo("", "cmbProveedorCant");
...
$(document).on("change", "#cmbProveedorCant", function () {
  var pkProveedor = $('#cmbProveedorCant').val();
  var html = ``;

  cargarCMBDevolucion("", "cmbDevolucionesCant", pkProveedor);
  ...
  html = `<div class="form-group">
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-6">
                ...
                <div class="row">
                  <div class="col-lg-12 input-group">
                    <select name="cmbDevolucionesCant" id="cmbDevolucionesCant" required>
...
$(document).on("change", "#cmbDevolucionesCant", function () {
  var html = ``, html2 = ``, html3 = ``;
            ...
            <div class="row">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="providers-disabled">
                  ...
                  <div class="row">
                    <div class="col-lg-12 input-group">
                      <select name="cmbCuentaPagarCant" id="cmbCuentaPagarCant" required>
            ...
            <div class="row">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                <div class="providers-disabled">
                  ...
                  <div class="row">
                    <div class="col-lg-12 input-group">
                      <select name="cmbTipoNotaCant" id="cmbTipoNotaCant" required>
  ...
  html3 = `<a class="btn-custom btn-custom--blue float-right" id="btnAgregarNotaCreditoCant">Agregar</a>`;
  ...
  cargarCMBCuentaPagarCant("", "cmbCuentaPagarCant",$("#cmbDevolucionesCant").val());
  cargarCMBTipoNota("", "cmbTipoNotaCant");

  deleteNotaCreditoCantidadProductosTemp();
  cargarTablaNotaCreditoCantidadProductos();
});
...
$(document).on("click", "#btnAgregarNotaCredito", function () {
...
$(document).on("click", "#btnAgregarNotaCreditoCant", function () {
...
function cargarTablaNotaCreditoCantidadProductos(){
...
function deleteNotaCreditoCantidadProductosTemp(){
  $.ajax({
    url: "../../php/funciones.php",
    data: { 
      clase: "delete_data", 
      funcion: "delete_datosNotaCreditoCantidadAllTemp",
    },
    dataType: "json",
    success: function (respuesta) {
      if (respuesta[0].status) {
