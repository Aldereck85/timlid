...
<head>
  ...
  <script src="../../../js/subir_Productos_Enviados_Sencillos.js"></script>
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header">
                  Factura con pedido parcial
                </div>
                <div class="card-body">
                    <div class="row">
                      <div class="col-lg-12">
                        <center>
                          <h4>Lo sentimos pero esta factura debe ser procesada por el administrador</h4><br>
                          <i class="fas fa-file-invoice fa-10x"></i><br>
