  ...
  <div id="wrapper">
    ...
    $titulo = '<div class="header-screen d-flex align-items-center">
                <div class="header-title-screen">
                  <h1 class="h3 mb-2">Agregar clientes</h1>
                </div>
              </div>';
    $ruta = "../../../";
            ...
            <div class="col-lg-12">
                <ul id="etiquetas" class="nav nav-tabs nav-fill" role="tablist">
                  <li class="nav-item pestanas_cliente" >
                    <a id="CargarDatosCliente" class="nav-link" href="#" ><h6 class="mb-0">Datos del cliente</h6></a>
                  </li>
                  <li class="nav-item pestanas_cliente">
                    <a id="CargarDatosFiscal" class="nav-link" ><h6 class="mb-0">Información fiscal</h6></a>
                  </li>
                  <li class="nav-item pestanas_cliente">
                    <a id="CargarDatosContacto" class="nav-link" ><h6 class="mb-0">Contacto</h6></a>
                  </li>
                  <li class="nav-item pestanas_cliente">
                    <a id="CargarDatosCuentasBancarias" class="nav-link" ><h6 class="mb-0">Cuentas bancarias</h6></a>
                  </li>
                  <li class="nav-item pestanas_cliente">
                    <a id="CargarListadoProductos" class="nav-link" ><h6 class="mb-0">Listado de productos</h6></a>
                  </li>
                </ul>
