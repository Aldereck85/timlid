  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        $id = $_POST['txtIdCorreo'];
        $proveedor = $_POST['txtIdProveedor'];
        $email = $_POST['txtEmail'];
        try{
        $stmt = $conn->prepare('UPDATE correos_proveedores set Email= :email WHERE PKEmail_Proveedor = :id');
      ...
      if(isset($_POST['idCorreoU'])){
        $id =  $_POST['idCorreoU'];
        $stmt = $conn->prepare('SELECT * FROM correos_proveedores WHERE PKEmail_Proveedor= :id');
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <form action="" method="post">
                          <input type="hidden" name="txtIdCorreo" value="<?=$id; ?>">
