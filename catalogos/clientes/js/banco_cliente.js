function cargarTablaBancos(id, _permissionsEdit) {
  $("#tblListadoDatosBancoCliente").dataTable({
    ...
    responsive: true,
    lengthChange: false,
    columnDefs: [{ orderable: false, targets: [0,5], visible: false },
                {targets:[2,3,4],class:"text-center"}],
    ...
    ajax: {
      ...
      data: {
        clase: "get_data",
        funcion: "get_banco_clientesTable",
        data: id,
