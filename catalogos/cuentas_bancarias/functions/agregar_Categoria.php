...
if (isset($_SESSION["Usuario"])) {
    ...
    try {
        $stmt = $conn->prepare('INSERT INTO categoria_gastos (Nombre, empresa_id, usuario_creacion_id, usuario_edicion_id, created_at, updated_at, estatus)
        VALUES (:nombre, :idemp, :usuario_creacion_id, :usuario_edicion_id, :created_at, :updated_at, 1)');
