...
if($existe_base_empresa == 0){
    ...
    if($tipo == 2){
        ...
        $stmt = $conn->prepare('INSERT INTO relacion_base_percepcion ( tipo_percepcion_id, tipo_base, cantidad, empresa_id) VALUES( :tipo_percepcion_id, :tipo_base, :cantidad, :empresa_id)');
        $stmt->bindValue(':tipo_percepcion_id', $idconcepto);
