                    ...
                    <div class="table-responsive">
                      <table class="table" id="tablaprueba" width="100%" cellspacing="0">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img class="z-depth-1-half" src="../../../../img/timdesk/ICONO AGREGAR3.svg" alt="Seleccionar producto" id="addProd" name="addProd" width="20px" height="20px" style=" position: relative;">
                            </td>
                            <td>
...
function agregarFila() {
    ...
    document.getElementById("tablaprueba").insertRow(-1).innerHTML =
      `<td>
        ...
        <img class="z-depth-1-half" src="../../../../img/timdesk/ICONO AGREGAR3.svg" alt="Seleccionar producto" id="addProd" name="addProd" width="10px" height="10px" style=" position: relative; margin: auto; display: inline;">
