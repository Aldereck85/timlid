      ...
      <div id="content">
        ...
        <?php
          ...
          $titulo = '<div class="header-screen">
                      ...
                      <h1 class="h3 mb-2">Timlid <img src="../../../../img/timdesk/timdesk_icon.svg" alt="" style="position:relative;top:-5px;left:-7px;"></h1>
                      </div>
                     </div>';
        ...
        <div class="container-fluid">
            ...
            <div class="divPageTitle" style="margin-left:10px;">
              ...
              <label class="lblPageTitle" style="margin-left:10px;font-weight:bold;">Editar entrada</label>
            </div>

            <!-- End Page Heading -->
            <input type="hidden" name="txtIdEntrada" id="txtIdEntrada" value="<?=$id; ?>">
            <!-- DataTales Example -->
            <div class="data-container">
              <div class="principal">
                <label for="cmbTipoEntrada">Tipo de entrada:</label>
                <input class="form-control" type="text" name="txtTipoEntrada" id="txtTipoEntrada" readonly>
                <input type="hidden" name="txtIdEditTipoEntrada" id="txtIdTipoEntrada">
                <!--<select name="cmbTipoEntrada" id="cmbTipoEntrada" disabled></select>-->
              </div>
              ...
              <div class="purchases-disabled" id="field-xml">
                ...
                <button class="btnesp espAgregar" id="fileXml_alt" type="button">Selección de XML</button>
            ...
            <div class="">
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table stripe" id="tblEditarEntradasProductos" width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Código</th>
                ...
                <div class="">
                  <button class="btnesp espAgregar float-right" type="button" name="btnEditarEntrada" id="btnEditarEntrada">Editar entrada</button>
                </div>
              </div>
            </div>
