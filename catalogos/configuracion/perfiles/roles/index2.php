            ...
            <div class="col-lg-12">
              ...
              <div class="card" style="border:0;background-color:transparent;">
                <div class="card-body">
                  <div class="row">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"><?=$_GET['usuario'];?></h1>
                  </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="card">
                                  ...
                                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                      <div class="row">
                                        <div class="col-lg-6">
                                          <input type="radio" id="rdoControlTotalRh" class="rdbHeader" name="gender" checked><label for="male">&nbsp;Control total</label><br>
                                          <input type="radio" id="rdoNoEliminarRh" class="rdbHeader" name="gender" ><label for="noEliminar">&nbsp;Controlar todo excepto eliminar</label><br>
                                          <input type="radio" id="rdoVerRh" class="rdbHeader" name="gender" ><label for="female">&nbsp;Solo lectura</label><br>
                                        </div>
                                        <div class="col-lg-6">
                                          <input type="radio" id="rdoSinPermisosRh" class="rdbHeader" name="gender" ><label for="female">&nbsp;Sin permisos</label><br>
                                          <input type="radio" id="rdoPersonalizadoRh" class="rdbHeader" name="gender" ><label for="female">&nbsp;Personalizado</label>
                                        </div>
                                      </div>
                                      <br>
                                      <div class="row">
