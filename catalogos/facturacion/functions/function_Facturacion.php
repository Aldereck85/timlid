<?php
  ...
  while($row = $stmt->fetch()){
    ...
    $table.='{"id":"'.$row['PKFacturacion'].'","Folio":"<a href=\"functions/ver_Factura.php?id='.$row['PKFacturacion'].'\">'.$row['Folio'].'</a>","Tipo":"'.$tipoCFDI.'","Razon social":"'.$row['Razon_Social'].'","Saldo":"'.$saldo.'","Fecha de timbrado":"'.$fecha.'","Estatus":"'.$estatus.'","Acciones":"'.$funciones.'"},';
    $no++;
  }
