	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='previ action-prev'></div>" :
				"<div class='previ action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='nexti action-next'></div>" :
				"<div class='nexti action-prev'></div>";
			...
			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "'>" +
					...
					"<div class='time'>" +
						top_arrow_button +
						"<div class='ti_tx'><input type='text' class='timepicki-input'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "><label>&nbsp;Hora(s)</label></div>" +
						bottom_arrow_button +
					"</div>" + 
					"<div class='mins'>" +
						top_arrow_button +
						"<div class='mi_tx'><input type='text' class='timepicki-input'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "><label>&nbsp;Minutos</label></div>" +
						bottom_arrow_button +
					"</div>");
			if(settings.show_meridian){
				new_ele.append(
