...
<body id="page-top">
          ...
          <div class="row">
            <div class="col-lg-12 config-tabs">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link" href="percepcionesbase.php">Percepciones</a>
                </li>
                <li class="nav-item">
  ...
  <script src="./js/deduccionesbase.js"></script>
  ...
  <script>
    ...
    function cargarDeduccion(idDeduccion){
     ...
     $("#btnGuardarBase").click(function(){
        ...
        let tipo = $('input[name="tipoBase"]:checked').val();
        let token = $("#csr_token_UT5JP").val(); 
        let baseEmpresa = "";
        let valor = "", valorObj;
        ...
        let longitudSucursales = $("#sucursales").html().trim();

        if(longitudSucursales != ""){
          if(clave.length < 1){
              Lobibox.notify("error", {
                size: 'mini',
                rounded: true,
                ...
                icon: false,
                img: '../../img/timdesk/warning_circle.svg',
                msg: "Si agregas base por sucursal, la clave no puede estar vacía."
              });
              return;
          }
        }
        ...
        $.ajax({
          type: 'POST',
          url: 'functions/agregarBaseDeduccion.php',
          data: { 
    ...
    $("#btnAgregarSucursal").click(function(){
        ...
        if(clave.length < 1){
            Lobibox.notify("error", {
              ...
              icon: false,
              img: '../../img/timdesk/warning_circle.svg',
              msg: "No puedes agregar una sucursal sin antes agregar la clave."
            });
            return;
        }

        if( $("#agregarClaveTipo input[name='tipoCalculoSuc']:radio").is(':checked')) {  
        ...
        $.ajax({
          type: 'POST',
          url: 'functions/agregarSucursalBaseDeduccion.php',
          data: { 
                  idconcepto : idconcepto,
      ...
      swalWithBootstrapButtons
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            $.ajax({
              type: 'POST',
              url: 'functions/eliminarSucursalBaseDeduccion.php',
              data: { 
