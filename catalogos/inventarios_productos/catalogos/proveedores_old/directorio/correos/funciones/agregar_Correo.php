    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO correos_proveedores (Email,FKProveedor)VALUES(:email,:proveedor)');
            $stmt->bindValue(':email',$email);
            $stmt->bindValue(':proveedor',$id);
            $stmt->execute();
...
<head>
  ...
  <title>Timlid | Agregar email</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Agregar cuenta email</h1>
          </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-lg-12">
                                ...
                                <input type="email" class="form-control alphaNumeric-only" maxlength="30" name="txtEmail" required>
                              </div>
