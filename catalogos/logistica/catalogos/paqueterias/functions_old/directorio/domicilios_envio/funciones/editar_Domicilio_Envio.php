  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE domicilio_de_envio_paqueterias set Calle= :calle,Numero_exterior= :numEx,Numero_Interior= :numInt,Colonia= :colonia,Municipio= :municipio,Estado= :estado,CP= :cp,Locacion= :locacion WHERE PKDomicilio = :id');
      ...
      if(isset($_POST['idDomiciliosEnvioU'])){
        $id =  $_POST['idDomiciliosEnvioU'];
        $stmt = $conn->prepare('SELECT * FROM domicilio_de_envio_paqueterias WHERE PKDomicilio= :id');
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <form action="" method="post">
                          <input type="hidden" name="txtIdDomicilio" value="<?=$id; ?>">
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-lg-2">
                                ...
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control numeric-only" maxlength="3" name="txtNumeroEx" value="<?=$numEx;?>" required>
                                </div>
                              </div>
                              <div class="col-lg-2">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control alpha-only" maxlength="20" name="txtLocacion" value="<?=$locacion;?>" required>
                              </div>
                            </div>
                          </div>
