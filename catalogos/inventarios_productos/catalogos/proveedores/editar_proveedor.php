...
$stmt->bindValue(':id', $Proveedor, PDO::PARAM_INT);
$stmt->execute();
$row = $stmt->fetch();
...
if (isset($_SESSION["Usuario"])) {
    ...
    if ($GLOBALS["PKProveedor"] != $PKEmpresa) {
        header("location:../../../inventarios_productos/catalogos/proveedores/");
    }
} else {
...
?>
        ...
        <input type="hidden" id="txtPKProveedor" value="<?=$Proveedor;?>">
        .
          ...
          <div class="row">
            <div class="col-lg-12">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a id="CargarDatosEdicionProveedor" class="nav-link" href="#"
                    onclick="CargarDatosProveedor(window.location.href = 'editar_proveedor.php?p='+$('#txtPKProveedor').val())">
                    Datos del proveedor
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosEdicionFiscal" class="nav-link"
                    onclick="SeguirDatosFiscales($('#txtPKProveedor').val())">
                    Información fiscal
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosEdicionContacto" class="nav-link"
                    onclick="SeguirContacto($('#txtPKProveedor').val())">
                    Contacto
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosEdicionCuentasBancarias" class="nav-link"
                    onclick="SeguirCuentasBancarias($('#txtPKProveedor').val())">
                    Cuentas bancarias
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarEdicionDireccionesEnvio" class="nav-link"
                    onclick="SeguirListadoProductos($('#txtPKProveedor').val())">
                    Productos
                  </a>
                </li>
              </ul>
...
?>
                          ...
                          <div class="row">
                            <div class="col-lg-12 input-group">
                              <input class="form-control numeric-only" type="text" name="txtTelefonoEdit"
                                id="txtTelefonoEdit" minlength="7" maxlength="10"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                          ...
                          <div class="row">
                            <div class="col-lg-12 input-group">
                              <input class="form-control numericDecimal-only" type="text" name="txtPrecioProdProveEdit"
                                id="txtPrecioProdProveEdit" required="" min="0" maxlength="13" placeholder="Ej. 30.00" onkeyup="validEmptyInput(this)">
                              <span class="input-group-addon" style="width:100px">
                                <select name="cmbMonedaPrecioEdit" id="cmbMonedaPrecioEdit" required="">
                                </select>
                              </span>
                              <div class="invalid-feedback" id="invalid-precioProdEd">El producto debe tener un precio.</div>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-6">
    ...
    <script src="../../js/editar_proveedores.js" charset="utf-8"></script>
    ...
    <script src="../../../../js/pestanas_proveedoresEdit.js"></script>
    ...
    CargarDatosProveedor($('#txtPKProveedor').val());
    </script>
