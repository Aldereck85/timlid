...
session_start();
  ...
  if(isset ($_POST['btnGuardar'])){
      ...
      $ISRProporcional = $_POST['ISRProporcional'];
      $Subsidio = $_POST['Subsidio'];
      $ISRRetenido = $_POST['ISRRetenido'];
      ...
      try{
        ...
        :isrproporcional, :subsidio, :isrretenido, 1)');
    ...
    $stmt = $conn->prepare("SELECT e.PKEmpleado, e.Primer_Nombre, e.Segundo_Nombre, e.Apellido_Paterno, e.Apellido_Materno, de.Fecha_Ingreso,
                                   p.Sueldo_semanal_bruto, de.Deuda_Restante, de.PKLaboralesEmpleado,t.Horas_de_trabajo, f.*
                            FROM empleados AS e
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <form action="" method="post">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <td>ISR Proporcional</td>
                                      <td>&nbsp</td>
                                      <td>&nbsp</td>
                                      <td id="lblISRProporcional"><?php if($row['PKFiniquito'] != "") echo number_format($ISRProporcionalBD,2,'.',''); else echo "0.00";?></td>
                                    </tr>
                                    <tr>
                                      <td>Subsidio correspondiente</td>
                                      <td>&nbsp</td>
                                      <td id="lblSubsidioMensual"><?php if($row['PKFiniquito'] != "") echo number_format($SubsidioBD,2,'.',''); else echo "0.00";?></td>
                                      <td id="lblSubsidioProporcional"><?php if($row['PKFiniquito'] != "") echo number_format($SubsidioProporcional,2,'.',''); else echo "0.00";?></td>
                                    </tr>
                                    <tr>
                                      <td>ISR Retenido</td>
                                      <td>&nbsp</td>
                                      <td id="lblTasaISR"><?php if($row['PKFiniquito'] != "") echo $tasa_isr; else echo "0.00";?></td>
                                      <td id="lblISRRetenido"><?php if($row['PKFiniquito'] != "") echo number_format($ISRetenidoBD,2,'.',''); else echo "0.00";?></td>
                                    </tr>
                                    <tr>
                                      <td>Total a pagar</td>
                                      <td>&nbsp</td>
                                      <td>&nbsp</td>
                                      <td id="lblTotalPagar" style="font-weight:800"><?php if($row['PKFiniquito'] != "") echo number_format($total_pagar,2,'.',''); else echo "0.00";?></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                          ...
                          <input type="hidden" name="ISRProporcional" id="ISRProporcional" value="" />
                          <input type="hidden" name="Subsidio" id="Subsidio" value="" />
                          <input type="hidden" name="ISRRetenido" id="ISRRetenido" value="" />
...
<script type="text/javascript">
  ...
  function actualizarFiniquito(){
    ...
    $.post( "functions/function_finiquito.php", { FKEmpleado: FKEmpleado, fecha_ingreso : fechaIngreso, fecha_salida : fechaSalida, dias_aguinaldo : dias_aguinaldo, salario_diario: salario_diario, SalariosDevengados : SalariosDevengados, HorasExtras : HorasExtras, prestamos : prestamos, dias_periodo : dias_periodo} ,function( data ) {
