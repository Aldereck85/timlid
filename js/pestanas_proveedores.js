                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-6">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="email" name="txtEmail" id="txtEmail" required="" maxlength="100" placeholder="Ej. ejemplo@dominio.com" onkeyup="validarCorreo(this.value)">
                            ...
                            <div class="col-lg-6">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="email" name="txtEmail2" id="txtEmail2" maxlength="100" placeholder="Ej. ejemplo@dominio.com" onkeyup="validarCorreo(this.value)">
                                </div>
                              </div>
                            </div>
                          </div>
...
function regresarDatosProveedor() {
...
function SeguirDatosFiscales(id) {
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="formDatosFiscales"> 
                        <input type='hidden' value='${id}' name="txtPKCliente" id="txtPKProveedor">
                        <span id="areaDiseno">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtReferenciaEdit" id="txtReferenciaEdit" maxlength="255" placeholder="Ej. Contacto camichines" onkeypress="return soloLetras(event)">
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-12 d-flex justify-content-end mt-4">
                              <a href="#" class="mr-4 btn-custom btn-custom--border-blue" id="btnAnadirProveedor" onclick="anadirRazonSocial(${id})">Añadir razón social</a>  
                              <a href="#" class="btn-custom btn-custom--blue" id="btnAgregarImpuesto" onclick="guardarDatosFiscales(${id})">Continuar</a>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
  ...
  cargarTablaRazonesSociales(id, 1);
  resetValidations();
}
...
function cargarCMBPaisesEditModal(data, input) {
  var html = "";
  var selected;
  $.ajax({
    url: "../../php/funciones.php",
...
function cargarCMBEstadosEditModal(data, input) {
  var valor = data;
  console.log("PKPais: " + valor);
  ...
  if (rfc != rfcHis) {
    $.ajax({
      ...
      success: function (data) {
        ...
        if (parseInt(data[0]["existe"]) == 1) {
          $("#invalid-razonSoc").text(
            "El RFC ya esta registado en el sistema."
          );
          $("#invalid-rfcEdit").css("display", "block");
          $("#txtRFCEdit").addClass("is-invalid");
        } else {
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="formDatosContacto"> 
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                    <input class="form-control" type="email" name="txtEmail" id="txtEmail" required="" maxlength="100" placeholder="Ej. ejemplo@dominio.com" onkeyup="validarCorreoContacto(this.value)">
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-12 d-flex justify-content-end mt-4" style="text-align:center!important; margin-top:25px;">
                              <a href="#" class="mr-4 btn-custom btn-custom--border-blue" id="btnAnadirContacto" onclick="validarContacto(${id})">Añadir contacto</a>  
                              <a href="#" class="btn-custom btn-custom--blue" id="btnAgregarContacto" onclick="guardarDatosContacto(${id})">Continuar</a>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-3">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <select name="cmbCostoUniVentaEspecial" id="cmbCostoUniVentaEspecial" required="" onchange="validEmptyInput(this, 'invalid-moneda')">
                                  </select>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-12 mt-4 d-flex justify-content-end">
                              <a href="#" class="mr-4 btn-custom btn-custom--border-blue" id="btnAnadirContacto" onclick="validarBanco(${id})">Añadir cuenta bancaria</a>  
                              <a href="#" class="btn-custom btn-custom--blue" id="btnAgregarCuentasBancarias" onclick="guardarDatosBancarios(${id})">Continuar</a>
                            </div>
                          </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtNombreProdProve" id="txtNombreProdProve" maxlength="255" placeholder="Ej. Bata quirúgica desechable">
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input required class="form-control numericDecimal-only" type="text" name="txtPrecioProdProve" id="txtPrecioProdProve" min="0" maxlength="13" placeholder="Ej. 30.00" onkeyup="validEmptyInput(this)">
                                  <span class="input-group-addon" style="width:100px">
                                    <select name="cmbMonedaPrecio" id="cmbMonedaPrecio">
                                    </select> 
                                  </span>
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control numeric-only" type="text" name="txtDiasEntregProdProve" id="txtDiasEntregProdProve"  min="0" placeholder="Ej. 15" maxlength="3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtUnidadMedida" id="txtUnidadMedida" maxlength="50" placeholder="Ej. Caja de 12 piezas">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-12 d-flex justify-content-end" style="margin-top:25px;">
                              <a href="#" class="btn-custom btn-custom--border-blue" id="btnAnadirProveedor" onclick="validarProveedor(${id})">Añadir producto</a>  
                              <a href="#" class="btn-custom btn-custom--blue ml-5" id="btnAgregarTipoProducto" onclick="guardarProductosProveedor(${id})">Volver a proveedores</a>
                            </div>
                          </div>
                        </div>
                        <br>
      ...
      success: function (data) {
        ...
        if (parseInt(data[0]["existe"]) == 1) {
          Lobibox.notify("error", {
            ...
            icon: true,
            img: "../../../../img/timdesk/notificacion_error.svg",
            msg: "¡El producto ya se encuentra registrado con el proveedor.!",
            sound: '../../../../../sounds/sound4'
          });
        } else {
          anadirProveedor();
    ...
    $.ajax({
      ...
      success: function (respuesta) {
        ...
        if (respuesta[0].status) {
          ...
          $("#invalid-precioProdU").css("display", "none");
