<?php
  ...
  while (($row = $stmt->fetch()) !== false) {
    ...
    if(!(isset($row['Dias_Credito']) && isset($row['Limite_Credito']))){
    ...
    $table.='{"Id":"<label class=\"textTable\">'.$row['PKProveedor'].'","Razon Social":"<label class=\"textTable\">'.$row['Razon_Social'].'","Nombre comercial":"<label class=\"textTable\">'.$row['Nombre_comercial'].'","RFC":"<label class=\"textTable\">'.$row['RFC'].'","Direccion":"<label class=\"textTable\">'.$row['Calle'].' No. '.$row['Numero_exterior'].' '.$imp.'","Colonia":"<label class=\"textTable\">'.$row['Colonia'].'","Municipio":"<label class=\"textTable\">'.$row['Municipio'].'","Estado":"<label class=\"textTable\">'.$row['Estado'].'","Codigo Postal":"<label class=\"textTable\">'.$row['CP'].'","Dias de credito":"<label class=\"textTable\">'.$dias.'","Limite de credito":"<label class=\"textTable\">'.$fecha.'"},';
  }
