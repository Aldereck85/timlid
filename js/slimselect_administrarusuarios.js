...
console.log(selected);
    ...
    Data.prototype.removeFromSelected = function (value, type) {
        ...
        if (this.main.config.isMultiple) {
            var values = [];
            var selected = this.getSelected();
            eliminar = jQuery.grep(selected, function (index) { return index.id == value });
            console.log(selected);
    ...
    Data.prototype.onDataChange = function () {
        ...
        var ids = eliminar[0].value;
        var idunico = ids.split("_");
        console.log(idunico[0] + "///" + idunico[1]);
         /*Eliminar FILA*/
        $.ajax({
              url : "../proyectos/functions/eliminarIntegrante.php",
              type: "POST",
              data : { "idEquipo": idunico[0], "idUsuario": idunico[1] },
...
var SlimSelect = (function () {
    ...
    SlimSelect.prototype.set = function (value, type, close, render) {
        console.log("HOLA24");
        agregado = jQuery.grep(this.data.data, function (index) { return index.id == value });
    ...
    SlimSelect.prototype.search = function (value) {
        console.log("HOLA29");
        var ids = agregado[0].value;
        var idunico = ids.split("_");
        var nombreAgregar = agregado[0].text;
         /*AGREGAR FILA*/
        $.ajax({
              url : "../proyectos/functions/agregarIntegrante.php",
              type: "POST",
              data : { "idEquipo": idunico[0], "idUsuario": idunico[1] },
              success: function(data,status,xhr)
              {
                if(data == "exito"){
                    ...
                    var agregar = '' +
                        '<div class="row elemento-equipo">' +
                            '<span class="col-md-6">' +
                              '<span data-toggle="tooltip" title="' + nombreAgregar + '"><img src="../../img/chat/users.svg" class="user-img img-responsive" width="25px"></span> ' +
                                ' <a href="#" class="color-blue">' + nombreAgregar + '</a>' +
                            '</span>' +
                            '<span class="col-md-6" align="right">' +
                                '<a href="#" data-toggle="tooltip" title="' + nombreAgregar + ' miembro del equipo">' +
                                    ' <img src="../../img/chat/estrella_inactiva.png" class="img-responsive">' + 
                                '</a> ' +
                                ' <a href="#" data-toggle="tooltip" title="Eliminar a ' + nombreAgregar + ' del equipo" onclick>' +
                                '<img src="../../img/chat/eliminar_usuario.png" class="img-responsive">' +
                            '</a>'+
                            '</span>' +
                        '</div>';
                    $("#equipo_" + idunico[0]).append(agregar);
                }
              }
...
var Slim = (function () {
    ...
    Slim.prototype.multiSelectedDiv = function () {
        console.log("HOLA49");
        console.log("LET3 UNA OPCION");
        var _this = this;
        var container = document.createElement('div');
        container.classList.add(this.main.config.multiSelected);
        
        var container2 = document.createElement('div');
        container2.classList.add(this.main.config.multiSelected);
        ...
        var values2 = document.createElement('div');
        values2.classList.add(this.main.config.values);
        container2.appendChild(values2);
      ...
      //  console.log(container);
       ...
       /* elementoListener.onclick = function (e) {
            if (!_this.main.config.isEnabled) {
                return;
            }
            var target = e.target;
