...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="z-index: 999;">
  ...
  <li class="nav-item">
    <a class="nav-link menu-icons" href="' . $ruta . 'dashboard.php">
        <img src="' . $ruta . '../img/menu/dashboard.svg" width="35px"  id="imagen-icono" data-toggle="tooltip" data-placement="right" title="Dashboard">
    </a>
  </li>
  ';
...
if ($_SESSION["FKRol"] == 1 || $_SESSION["FKRol"] == 4) {
    echo '
      ...
      <li class="nav-item">
        <a class="nav-link menu-icons collapsed" href="#" data-toggle="collapse" data-target="#recursos_humanos" aria-expanded="true" aria-controls="collapseTwo">
        <img src="' . $ruta . '../img/menu/rh.svg" width="35px"  id="imagen-icono" data-toggle="tooltip" data-placement="right" title="Recursos humanos">
        </a>
        <div id="recursos_humanos" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-subMenu py-2 collapse-inner rounded">
            ...
            <a class="collapse-item linkWhite" href="' . $ruta . 'empleados/estatus_empleado.php">Estatus de empleado</a>
      ';
    if ($_SESSION["FKRol"] == 4) {
        echo '<a class="collapse-item linkWhite" href="' . $ruta . 'puestos/">Puestos</a>
...
if ($_SESSION["FKRol"] != 4) {
    echo '<a class="collapse-item" href="' . $ruta . 'organigrama/organigrama.php"><i class="fas fa-sitemap"></i> Organigrama</a>';
}

if ($_SESSION["FKRol"] == 5) {
    echo '
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#recursos_humanos" aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-user-tie"></i>
            <span>Recursos Humanos</span>
          </a>
          <div id="recursos_humanos" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-subMenu py-2 collapse-inner rounded">
              <a class="collapse-item" href="' . $ruta . 'nomina/"><i class="fas fa-business-time"></i> Nomina por turno</a>
              <a class="collapse-item" href="' . $ruta . 'bono/"><i class="fas fa-money-check-alt"></i> Bono mensual</a>';
}
?>
</div>
</div>
...
<li class="nav-item">
  <a class="nav-link collapsed menu-icons" href="#" data-toggle="collapse" data-target="#ventas" aria-expanded="true"
    ...
    <img src="<?php echo $ruta ?>../img/menu/ventas.svg" width="35px" id="imagen-icono" data-toggle="tooltip"
...
<li class="nav-item">
  <a class="nav-link collapsed menu-icons" href="#" data-toggle="collapse" data-target="#administracion"
    ...
    <img src="<?php echo $ruta ?>../img/menu/timdesk.svg" width="35px" id="imagen-icono" data-toggle="tooltip"
...
<li class="nav-item">
  <a class="nav-link collapsed menu-icons" href="#" data-toggle="collapse" data-target="#inventarios"
    aria-expanded="true" aria-controls="collapseTwo">
    <img src="<?php echo $ruta ?>../img/menu/inventarios.svg" width="35px" id="imagen-icono" data-toggle="tooltip"
  ...
  <div id="inventarios" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-subMenu py-2 collapse-inner rounded">
      <a class="collapse-item" href="<?=$ruta;?>proveedores/">Proveedores</a>
      <a class="collapse-item" href="<?=$ruta;?>orden_compras/">Ordenes de compras</a>
      <a class="collapse-item" href="<?=$ruta;?>compras_productos/">Compras</a>
      <a class="collapse-item" href="<?=$ruta;?>tipos_producto/">Tipos de productos</a>
      <a class="collapse-item" href="<?=$ruta;?>productos/">Lista de productos</a>
      <a class="collapse-item" href="<?=$ruta;?>unidad_medida/">Unidades de medida</a>
      <a class="collapse-item" href="<?=$ruta;?>marcas/">Listado de marcas</a>
      <a class="collapse-item" href="<?=$ruta;?>inventario/">Inventario</a>
...
<li class="nav-item">
  <a class="nav-link collapsed menu-icons" href="#" data-toggle="collapse" data-target="#vehiculos" aria-expanded="true"
    aria-controls="collapseTwo">
    <img src="<?php echo $ruta ?>../img/menu/vehiculos.svg" width="35px" id="imagen-icono" data-toggle="tooltip"
...
<li class="nav-item">
  <a class="nav-link collapsed menu-icons" href="#" data-toggle="collapse" data-target="#textiles" aria-expanded="true"
    aria-controls="collapseTwo">
    <img src="<?php echo $ruta ?>../img/menu/textil.svg" width="35px" id="imagen-icono" data-toggle="tooltip"
