...
<head>
  ...
  <title>Timlid | Agregar vehículos</title>
  ...
  <link href="../../style/pestanas_vehiculos.css" rel="stylesheet">
...
?>
          ...
          <div class="row">
            <div class="col-lg-12">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a id="CargarDatosVehiculo" class="nav-link nav-link--add">
                    Datos del vehículo
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosCombustible" class="nav-link nav-link--add">
                    Combustible
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosPolizaSeguro" class="nav-link nav-link--add">
                    Póliza de seguro
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosServicios" class="nav-link nav-link--add">
                    Servicios
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosPrestamos" class="nav-link nav-link--add">
    ...
    <script src="../../js/agregar_vehiculo.js" charset="utf-8"></script>
    <script src="../../../../js/slimselect.min.js"></script>
    <script src="../../../../js/pestanas_vehiculos.js"></script>
      ...
      <form action="" method="POST" id="formDatosCombustibleEdit">
        ...
        <div class="modal-footer justify-content-center">
          <button type="button" class="btn-custom btn-custom--blue" data-dismiss="modal" data-toggle="modal"
            data-target="#eliminar_CargaCombustible">Eliminar
          </button>
...
<div class="modal fade right" id="editar_Servicios" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
    <div class="modal-content">
      <form action="" method="POST" id="formDatosServiciosEdit">
        <!--<input type="hidden" name="idProyectoA" value="">-->
        <div class="modal-header">
        ...
        <div class="modal-footer justify-content-center">
          <button type="button" class="btn-custom btn-custom--blue" data-dismiss="modal" data-toggle="modal"
            data-target="#eliminar_Servicio">Eliminar
          </button>
          <button type="button" class="btn-custom btn-custom--border-blue" data-dismiss="modal" id="">
            Cancelar
          </button>
