...
*/
        ...
        $titulo_archivo = "nomina_general_".$datosNomina['no_nomina'];
        ...
        foreach($datosEmpleados as $de){
                ...
                $encabezado = '
                  <table>
                    ...
                    <tr>
                      ...
                      <td width="80%">'.$nombreEmpleadoActual.'</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="15%">'.$de['Turno'].'</td>
                      <td width="15%"><b>NSS: </b></td>
                      <td width="15%">'.$de['NSS'].'</td>
                      <td width="15%"><b>Puesto: </b></td>
                      <td width="15%">'.$de['puesto'].'</td>
                    </tr>
                    <tr>
                      <td width="15%"><b>RFC: </b></td>
                      <td width="35%">'.$de['RFC'].'</td>
                      <td width="15%"><b>Fecha de ingreso: </b></td>
                      <td width="35%">'.$de['FechaIngresoFormat'].'</td>
                    </tr>
                  </table>';
                ...
                <table>
                  ...
                  $total_deducciones = 0.00; $total_otros_pagos = 0.00;
                  ...
                  if($de['SAE'] > 0){
                    ...
                    $tblenc .= '
                      <tr>
                        ...
                        <td width="20%">0.00</td>
                        <td width="20%">0.00</td>
                        <td width="20%">' . number_format($de['SAE'],2,'.',',') . '</td>
                      </tr>';
                  ...
                  foreach($datosPercepciones as $dp){
                    ...
                    $tblenc .= '
                            <tr>
                              <td width="40%" class="izquierda">'.$dp['clave']." - ".$dp['codigo']." - ".$dp['concepto'].'</td>
                  ...
                  if($de['ISR'] > 0){
                    ...
                    $tblenc .= '
                            <tr>
                              ...
                              <td width="20%">' . number_format($de['ISR'],2,'.',',') . '</td>
                              <td width="20%">0.00</td>
                              <td width="20%">' . number_format($de['ISR'],2,'.',',') . '</td>
                            </tr>';
                  ...
                  if($de['cuotaIMSS'] > 0){
                    ...
                    $tblenc .= '
                            <tr>
                              ...
                              <td width="20%">' . number_format($de['cuotaIMSS'],2,'.',',') . '</td>
                              <td width="20%">0.00</td>
                              <td width="20%">' . number_format($de['cuotaIMSS'],2,'.',',') . '</td>
                            </tr>';
