  ...
  <div id="wrapper">
    ...
    $titulo = '<div class="header-screen d-flex align-items-center">
                <div class="header-title-screen">
                  <h1 class="h3 mb-2">Lista de Productos</h1>
                </div>
              </div>';
    $ruta = "../../../";
    ...
    <div class="modal-content">
      <form action="" method="POST">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" onclick="eliminarProducto();" class="btnesp espAgregar float-right"><span
