              ...
              <form id="order_production-data">
                ...
                <div class="form-group form-row">
                  ...
                  <div class="col">
                    ...
                    <select class="workgroup-select" name="cmbGrupoTrabajo" id="cmbGrupoTrabajo" multiple disabled required></select>
                    <div class="invalid-feedback" id="invalid-workGroup">La orden de producción debe de tener un grupo de trabajo.</div>
                  </div>
                </div>
              </form>
