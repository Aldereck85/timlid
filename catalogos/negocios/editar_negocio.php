...
if (isset($_SESSION["Usuario"])) {
    ...
    $query = "SELECT nombre, valor, cliente_id, empleado_id, etapa_empresa_usuario_id, prioridad_id, usuario_id, created_at, update_at, contacto_id, prospecto_id, descripcion
    FROM negocios
    WHERE id = :negocio_id";
    $rst = $conn->prepare($query);
    $rst->execute([':negocio_id' => $_REQUEST["id"]]);
    $negocio = $rst->fetch(PDO::FETCH_OBJ);
} else {
...
<head>
    ...
    <script src="js/editar_negocio.js"></script>
...
<body id="page-top" class="sidebar-toggled">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <input type="hidden" id="idNegocioHdd" value="<?= $_REQUEST["id"]; ?>">
                                        ...
                                        <form id="formAgregarNegocio">
                                                ...
                                                <div class="radio col-lg-4">
                                                    <div class="row">
                                                        <label class="col-lg-6">
                                                            <?php if($negocio->prospecto_id != null){ ?>
                                                                <input type="radio" name="tipoContacto" value="lead" required id="tipo" disabled checked>
                                                            <?php }else{ ?>
                                                                <input type="radio" name="tipoContacto" value="lead" required id="tipo" disabled>
                                                            <?php } ?>
                                                            <span class="px-2">Lead</span>
                                                        </label>
                                                        <label class="col-lg-6">
                                                            <?php if($negocio->cliente_id != null){ ?>
                                                                <input type="radio" name="tipoContacto" value="cliente" required id="tipo" disabled checked>
                                                            <?php }else{ ?>
                                                                <input type="radio" name="tipoContacto" value="cliente" required id="tipo" disabled>
                                                            <?php } ?>
                                                    ...
                                                    <div id="div_emprePros" class="form-group">
                                                        <select name="contacto" id="empresaProsSelect">
                                                            ...
                                                            <?php foreach ($prospectos as $prospecto) { ?>
                                                                <?php if($negocio->prospecto_id == $prospecto->id){ ?>
                                                                    <option value="<?= $prospecto->id ?>" selected><?= $prospecto->empresa ?></option>
                                                                <?php }else{ ?>
                                                    ...
                                                    <div id="div_empreClie" class="form-group d-none">
                                                        <select name="cliente" id="empresaClieSelect">
                                                            ...
                                                            <?php foreach ($clientes as $cliente) { ?>
                                                                <?php if($negocio->cliente_id == $cliente->PKCliente){ ?>
                                                                    <option value="<?= $cliente->PKCliente ?>" selected><?= $cliente->NombreComercial ?></option>
                                                                <?php }else{ ?>
                                            ...
                                            <div class="row form-group">
                                                <div class="radio col-lg-4">
                                                    ...
                                                    <div class="row" id="div_etapas">
                                                        <div class="col-lg-12 input-group">
                                                            <input type="hidden" name="prioridadHdd" id="prioridadHdd" value="<?= $negocio->prioridad_id ?>">
                                                ...
                                                <div class="radio col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control alphaNumeric-only" maxlength="50" name="nombre" id="nombre" required value="<?= $negocio->nombre ?>">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="row" id="div_etapas">
                                                        <div class="col-lg-12 input-group">
                                                            <input type="hidden" name="etapaHdd" id="etapaHdd" value="<?= $negocio->etapa_empresa_usuario_id ?>">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control alphaNumeric-only" name="valor" id="valor" maxlength="12" required data-type="currency" placeholder="$1,000,000.00" value="<?= $negocio->valor ?>">
                                                    <input type="hidden" name="" id="valor_1" value="<?= $negocio->valor ?>">
                                                        ...
                                                        <div class="col-lg-12 input-group">
                                                            <select name="propietario" id="propietario">
                                                                ...
                                                                <?php foreach ($propietarios as $propietario) { ?>
                                                                    <?php if($negocio->empleado_id == $propietario->PKEmpleado){ ?>
                                                                        <option value="<?= $propietario->PKEmpleado ?>" selected><?= $propietario->nombre ?></option>
                                                                    <?php }else{ ?>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-lg-4">
                                                    <input type="hidden" name="contactoHdd" id="contactoHdd" value="<?= $negocio->contacto_id ?>">
                                                    <label for="contacto">Contacto:</label>
                                                    <select name="contacto" id="contacto"></select>
                                                </div>
                                                <div class="col-lg-8">
                                                    <label for="descripcion">Descripción:</label>
                                                    <textarea class="form-control" name="descripcion" id="descripcion"><?= $negocio->descripcion ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group mt-4">
                                                ...
                                                <div class="col-lg-12">
                                                    <button type="submit" class="float-right btn-custom btn-custom--blue ml-3" id="btnEditarNegocio">Guardar</button>
                                                    <button type="submit" class="float-right btn-custom btn-custom--blue" id="btnEliminarNegocio">Eliminar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
