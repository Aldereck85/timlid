...
<head>
  ...
  <title>Timlid | Agregar paquetería</title>
  ...
  <link href="../../style/pestanas_paqueterias.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a id="CargarDatosPaqueteria" class="nav-link nav-link--add">
                ...
                <li class="nav-item">
                  <a id="CargarSucursales" class="nav-link nav-link--add">
                    Sucursales
                  </a>
                </li>
              </ul>
    ...
    <script src="../../js/agregar_paqueteria.js" charset="utf-8"></script>
    <script src="../../../../js/slimselect.min.js"></script>
    <script src="../../../../js/pestanas_paqueterias.js"></script>
...
<div class="modal fade right" id="editar_Sucursal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <!-- Add class .modal-full-height and then add class .modal-right (or other classes from list above) to set a position to the modal -->
  <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
    <div class="modal-content">
