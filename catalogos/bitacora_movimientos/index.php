...
<head>
  ...
  <title>Timlid | Bitacora de movimientos</title>
  ...
  $(document).ready(function() {
    ...
    $("#tblBitacora").dataTable({
        ...
        "lengthChange": false,
        "info": false,
        "ajax": "functions/function_Bitacora.php",
        "columns": [{
            "data": "No"
          },
          {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Bitacora de movimientos</h1>
          <p class="mb-4">Información general de los movimientos</p>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table" id="tblBitacora" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Usuario</th>
