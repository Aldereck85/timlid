...
<body id="page-top">
          ...
          <div class="row">
            <div class="col-lg-12 config-tabs">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="deduccionesclave.php">Deducciones</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <script src="./js/percepcionesclave.js"></script>
  ...
  <script>
    ...
    function cargarPercepcion(idPercepcion){
     ...
     $("#btnGuardarBase").click(function(){
        ...
        $.ajax({
          type: 'POST',
          url: 'functions/agregarClave.php',
          data: { 
