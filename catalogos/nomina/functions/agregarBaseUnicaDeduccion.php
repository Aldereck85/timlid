...
$stmt = $conn->prepare('SELECT id FROM relacion_base_deduccion WHERE relacion_concepto_deduccion_id = :idConcepto AND empresa_id = :empresa_id');
...
$stmt = $conn->prepare('INSERT INTO relacion_base_deduccion ( relacion_concepto_deduccion_id , tipo_base, cantidad, empresa_id) VALUES( :relacion_concepto_deduccion_id, :tipo_base, :cantidad, :empresa_id)');
