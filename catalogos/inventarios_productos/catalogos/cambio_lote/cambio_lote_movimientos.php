...
<head>
    ...
    <script src="../../js/cambio_lote_movimientos.js" charset="utf-8"></script>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <input type="hidden" id="inputCambio" value="<?= $_REQUEST['data1']; ?>">
                ...
                <input type="hidden" id="inputTipoCambio" value="<?= $_REQUEST['data6']; ?>">
                                    ...
                                    <div class="row" id="rowTabla">
                                        <div class="col">
                                            <div class="table-responsive">
                                                <table class="table" id="tblMovimientosCambio" class="display" width="100%" cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                            <th class="d-none">IdDetalleCambio</th>
                                                            <th>Clave</th>
                                                            <th>Nombre</th>
                                                            <th>Cantidad</th>
                                                            <!--<th>Serie</th>-->
