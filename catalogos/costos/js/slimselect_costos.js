...
var Config = (function () {
    function Config(info) {
        ...
        this.searchText = 'No hay resultados';
        this.searchingText = 'Buscando...';
        this.placeholderText = 'Seleccionar valor';
...
var Slim = (function () {
    ...
    Slim.prototype.searchDiv = function () {
        ...
        if (this.main.addable) {
            ...
            addable.classList.add('link');
           /* $(".uniquetooltip").attr("data-toggle", "dropdown");
                      data-placement="top" title="" data-original-title="Cambia de proyecto"*/
            addable.innerHTML = '+';
            ...
            tool.classList.add('tooltip-unico');
            tool.innerHTML = 'Añadir producto';
