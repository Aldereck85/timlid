...
session_start();
  ...
  if(isset ($_POST['btnGuardar'])){
    ...
    $stmt = $conn->prepare("SELECT e.PKEmpleado, e.Primer_Nombre, e.Segundo_Nombre, e.Apellido_Paterno, e.Apellido_Materno, de.Fecha_Ingreso,
                                   p.Sueldo_semanal, de.Deuda_Restante, de.PKLaboralesEmpleado,t.Horas_de_trabajo, f.*
                            FROM empleados AS e
    ...
    $Sueldo_semanal = number_format($row['Sueldo_semanal'],2,'.','');
    $Sueldo_diario = $row['Sueldo_semanal'] / 7;
    ...
    $sueldo_Hora = $row['Sueldo_semanal'] / $horasTrabajo;
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-lg-6">
                                ...
                                <input type="number" maxlength="11" class="form-control numeric-only upperCaseletter" name="sueldo_diario_integrado" id="sueldo_diario_integrado" value="<?=number_format($Sueldo_diario_integrado,2,'.','')?>" readonly>
                              </div>
                              <!--
                              <div class="col-lg-4">
