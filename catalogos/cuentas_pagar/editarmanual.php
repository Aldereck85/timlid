...
<head>
  ...
  <script type="text/javascript" src="js\editManual.js"></script>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                        <div class="providers-disabled">
                                            ...
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="radioDoc" id="factura" value="1" checked>
                                                    <label class="form-check-label" for="factura">
                                                    Factura
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="radioDoc" id="remision" value="2">
                                                <label class="form-check-label" for="remision">
                                                    Remision
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="radioDoc" id="anticipo" value="4">
