...
session_start();
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    ...
    if(isset ($_POST['btnAgregar'])){
      ...
      try{
        $stmt = $conn->prepare('INSERT INTO unidad_medida (FKClaveSAT,Unidad_de_Medida,Piezas_por_Caja) VALUES (:clave,:unidad,:pieza)');
...
<head>
  ...
  <title>Timlid | Agregar unidad de medida</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Agregar unidad de medida</h1>
          </div>
                            ...
                            <div class="row">
                              <div class="col-lg-4">
                                ...
                                <select class="form-control" name="cmbClaveSAT" id="cmbClaveSAT">
                                  ...
                                  ?>
                                  <option value="<?=$row['PKClaveSATUnidad']; ?>"><?=$row['Clave']." - ".$row['Descripcion']; ?></option>
                                <?php } ?>
                                </select>
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Unidad de medida:</label>
                                <input type="text" class="form-control alpha-only" maxlength="10"  name="txtUnidadMedida" required>
                              </div>
                              <div class="col-lg-4">
                                <label for="usr">Piezas por caja:</label>
                                <input type="text" class="form-control numeric-only" maxlength="5"  name="txtPiezas" required>
                              </div>
                            </div>
                          </div>
