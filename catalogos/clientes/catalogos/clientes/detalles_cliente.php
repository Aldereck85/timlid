...
$stmt = $conn->prepare("SELECT razon_social, rfc, empresa_id FROM clientes WHERE PKCliente = :id");
$stmt->bindValue(':id', $Cliente, PDO::PARAM_INT);
$stmt->execute();
$row = $stmt->fetch();

$GLOBALS["PKCliente"] = $row['empresa_id'];
$GLOBALS["RazonSocial"] = $row['razon_social'];
$GLOBALS["Rfc"] = $row['rfc'];
...
<head>
  ...
  <title>Timlid | Detalles cliente</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a id="cargarDatosPagos" class="nav-link" onclick="cargarDatosPagos($('#txtPKCliente').val())">
                    Cuentas por cobrar
                  </a>
                </li>
                <!-- <li class="nav-item">
                  <a id="cargarDatosVentas" class="nav-link" onclick="cargarDatosVentas($('#txtPKCliente').val())">
                    Ventas
                  </a>
                </li> -->
                <li class="nav-item">
                  <a id="cargarDatosCotizacion" class="nav-link" onclick="cargarDatosCotizacion($('#txtPKCliente').val())">
                    Cotizaciones
                  </a>
                </li>
                <li class="nav-item">
                  <a id="cargarDatosPedidos" class="nav-link" onclick="cargarDatosPedidos($('#txtPKCliente').val())">
                    Pedidos
                  </a>
                </li>
              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                  <div class="row">
                    <div class="col-6">
                      <h2 Style="color:var(--color-primario)"><?php echo $GLOBALS["RazonSocial"]; ?></h2>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-6">
                      ...
                      <a href="#" onclick="obtenerIdClienteEditar(<?=$Cliente;?>)"><img src="../../../../img/Clientes/BOTON EDITAR CLIENTE AZUL NVO-01.svg" alt="" width="240"></a>
                    </div>
                    <div class="col-3">
    ...
    <script src="../../js/detalles_cliente.js" charset="utf-8"></script>
    <script type="text/javascript">
      cargarDatosPagos($('#txtPKCliente').val());
    </script>
</body>
