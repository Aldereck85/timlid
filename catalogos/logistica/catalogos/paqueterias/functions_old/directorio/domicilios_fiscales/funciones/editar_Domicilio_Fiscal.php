  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4 || $_SESSION["FKRol"] == 1)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE domicilio_fiscal set Calle= :calle,Numero_exterior= :numEx,Numero_Interior= :numInt,Colonia= :colonia,Municipio= :municipio,Estado= :estado,CP= :cp,Locacion= :locacion WHERE PKDomicilioFiscal = :id');
...
<head>
  ...
  <title>Timlid | Editar domicilio fiscal</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Editar domicilio fiscal</h1>
          </div>
