...
<head>
  ...
  <link rel="stylesheet" href="../../style/vehiculos.css">
  ...
  <script src="../../js/vehiculos.js" charset="utf-8"></script>
...
<div class="modal fade" id="eliminar_Vehiculo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <form action="" method="POST">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="obtenerEliminarVehiculo()" data-dismiss="modal" class="btn-custom btn-custom--blue">
