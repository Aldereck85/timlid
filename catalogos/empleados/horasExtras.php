...
<head>
  ...
  <title>Timlid | Horas extras</title>
  ...
  <script>
    $(document).ready(function(){
      ...
      $('#cmbPeriodo').on('change', function() {
        ...
        {
          "ajax":"functions/function_horasExtras.php?id="+idEmpleado+"&semana="+idSemana,
            "columns":[
              {"data":"Dia"},
              {"data":"Id empleado"},
              {"data":"Fecha"},
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Horas extras</h1>
          <p class="mb-4">Información de dobles turno por empleado</p>
