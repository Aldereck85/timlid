...
$rutaServer = $_ENV['RUTA_ARCHIVOS_READ'].$PKEmpresa.'/temp'.'/';
?>
...
<head>
  ...
  <title>Timlid | Agregar producto</title>
          ...
          <div class="row">
            <div class="col-lg-12">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a id="CargarDatosProducto" class="nav-link nav-link--add">
                    Datos del producto
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosImpuestos" class="nav-link nav-link--add">
                    Información fiscal
                  </a>
                </li>
                <li class="nav-item">
                  <a id="CargarDatosInventario" class="nav-link nav-link--add">
                    Inventario
                  </a>
                </li>
                <li class="nav-item" id="pestDatosProveedor" style="pointer-events:none; opacity:0.4;">
                  <a id="CargarDatosProveedor" class="nav-link nav-link--add">
                    Proveedor
                  </a>
                </li>
                <!--<li class="nav-item">
                ...
                <li class="nav-item" id="pestDatosVenta" style="pointer-events:none; opacity:0.4;">
                  <a id="CargarTiposProducto" class="nav-link nav-link--add">
                    Datos de Venta
                  </a>
                </li>
              </ul>
...
?>
    ...
    <div class="modal fade right" id="editar_Proveedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
      ...
      <div class="modal-dialog modal-full-height modal-right modal-lg" role="document">
        <div class="modal-content">
          <form action="" method="POST" id="formDatosProveedorEdit">
            <!--<input type="hidden" name="idProyectoA" value="">-->
            <div class="modal-header">
                          ...
                          <div class="row">
                            <div class="col-lg-12 input-group">
                              ...
                              <input type="text" class="form-control" name="txtClaveProdProveEdit"
                                ...
                                onkeyup="escribirClaveProveedorEdit()">
                          ...
                          <div class="row">
                            <div class="col-lg-12 input-group">
                              <input class="form-control numericDecimal-only" type="text" name="txtPrecioProdProveEdit"
                                id="txtPrecioProdProveEdit" required="" min="0" maxlength="13"
                          ...
                          <div class="row">
                            <div class="col-lg-12 input-group">
                              <input class="form-control numeric-only" type="text" name="txtCantMinProdProveEdit"
                                id="txtCantMinProdProveEdit" autofocus="" required="" min="0" maxlength="12"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                placeholder="Ej. 1000">
                            ...
                            <div class="col-lg-12 input-group">
                              <span class="input-group-addon" style="width:100%">
                                <input class="form-control" type="text" name="txtUnidadMedidaEdit"
                                  id="txtUnidadMedidaEdit" autofocus="" required="" min="0" maxlength="50"
            ...
            <div class="modal-footer justify-content-center">
              <button type="button" class="btnesp espAgregar float-right"><span class="ajusteProyecto"
                  data-dismiss="modal" data-toggle="modal" data-target="#eliminar_Proveedor">Eliminar</span></button>
              <button type="button" class="btnesp first espCancelar" data-dismiss="modal" id=""><span
                  class="ajusteProyecto">Cancelar</span></button>
              <button type="button" class="btnesp espAgregar float-right"
                onclick="validarProveedorEdit($('#txtPKProductoProveedorEdit').val())"><span
                  class="ajusteProyecto">Guardar cambios</span></button>
            </div>
          </form>
        </div>
      </div>
    ...
    <!--DELETE MODAL SLIDE INVENTARIO PRODUCTOS -->
    <div class="modal fade" id="eliminar_inventario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">

          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">¿Desea eliminar este registro de las existencias del producto?</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">x</span>
            </button>
          </div>
          ...
          <div class="modal-footer">
            <button class="btnesp first espCancelar btnCancelarActualizacion" type="button" data-dismiss="modal" id="btnCancelarCuenta"><span class="ajusteProyecto">Cancelar</span></button>
            <button type="submit" class="btnesp espAgregar float-right" data-dismiss="modal"><span class="ajusteProyecto" onclick="eliminarImventario()">Eliminar</span></button>
          </div>

        </div>
      </div>
    </div>
    <!--END DELETE MODAL SLIDE INVENTARIO PRODUCTOS -->

    <!--DELETE MODAL SLIDE INVENTARIO PRODUCTOS CONTINUAR -->
    <div class="modal fade" id="continuar_sinGuardar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">

          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Datos sin guardar</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">x</span>
            </button>
          </div>
          <div>
            <br>
            <h4>¿Desea continuar sin guardar el inventario?</h4>
            <br>
          </div>
          <div class="modal-footer">
            <button class="btnesp first espCancelar btnCancelarActualizacion" type="button" data-dismiss="modal" id="btnCancelarCuenta"><span class="ajusteProyecto">Cancelar</span></button>
            <button type="submit" class="btnesp espAgregar float-right" data-dismiss="modal"><span class="ajusteProyecto" onclick="continuarSinGuardar()">Continuar</span></button>
          </div>

        </div>
      </div>
    </div>
    <!--END DELETE MODAL SLIDE INVENTARIO PRODUCTOS CONTINUAR -->


    <script src="../../../../js/sb-admin-2.min.js"></script>
    <script src="../../../../js/scripts.js"></script>
    <script src="../../../../js/notificaciones_timlid.js" charset="utf-8"></script>
    <script src="../../js/agregar_productos.js" charset="utf-8"></script>
    ...
    <script src="../../../../js/pestanas_productos.js"></script>
