  ...
  if(isset($_SESSION["Usuario"]) && ($_SESSION["FKRol"] == 4)){
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnEditar'])){
        ...
        try{
        $stmt = $conn->prepare('UPDATE datos_contacto set Nombre= :nombre,Apellido_Paterno= :apellido,Puesto= :puesto,Telefono= :telefono,Celular= :celular,Email= :email WHERE PKContacto = :id');
