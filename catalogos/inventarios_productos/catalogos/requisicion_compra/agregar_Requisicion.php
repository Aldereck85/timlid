...
<head>
  ...
  <title>Timlid | Agregar Requisición de compra</title>
...
<body id="page-top">
                    ...
                    <div class="col-lg-12">
                      <form action="" method="post" id="frmRequisicionCompra">
                       <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-2">
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control" maxlength="20" id="txtFechaEmision" value="<?php echo (date('Y-m-d'));?>" readonly required>
                          ...
                          <div class="col-lg-3">
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control" maxlength="20" name="txtFechaEstimada" id="txtFechaEstimada" min="<?php echo (date('Y-m-d'));?>" required onchange="validEmptyInput(this)">
                        ...
                        <br>
                        <button type="button" class="btn-custom btn-custom--blue" name="btnAgregar" id="btnAgregar" onclick="saveRequisicion()" style="float:right">
                          Guardar Requisición
                        </button>
  ...
  <script src="js/agregar_requisicionCompra.js" charset="utf-8"></script>
