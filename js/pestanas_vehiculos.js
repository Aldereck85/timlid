                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <div class="row">
                                <div class="col-lg-12 input-group">
                                  <input class="form-control" type="text" name="txtMarca" id="txtMarca" required maxlength="255" placeholder="Marca del vehículo" onchange="validEmptyInput('txtMarca', 'invalid-marca', 'El vehículo debe tener una marca.')">
                      ...
                      <a class="btn-custom btn-custom--blue float-right" id="btnAgregarVehiculo">Continuar</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      $.ajax({
        ...
        success: function (respuesta) {
          if (respuesta[0].status) {
            ...
            SeguirDatosCombustible(respuesta[0].id);
          } else {
              ...
              <span id="areaDiseno">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-lg-2" style="text-align:center!important; margin-top:35px;">
                      <a href="#" class="btn-custom btn-custom--blue float-right" id="btnContinuarPoliza">Continuar </a>
                    </div>
                  </div>
                </div>
                <div class="form-group">
...
$(document).on("click", "#btnContinuarPoliza", function () {
  SeguirPolizaSeguro(_global.PKVehiculo);
});
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-12 mt-4 d-flex justify-content-end">
                              <a href="#" class="mr-3 btn-custom btn-custom--border-blue" id="btnAnadirPolizaSeguro">Guardar y continuar</a>
                            </div>
                            <p>* Campos requeridos</p>
                          </div>
                        </div>
      ...
      $.ajax({
        ...
        success: function (respuesta) {
          if (respuesta[0].status) {
            ...
            $("#txtNoPoliza").val("");
            $("#txtAseguradora").val("");
            $("#txtFechaInicio").val("0000-00-00");
            $("#txtFechaTermino").val("0000-00-00");
            $("#txtInciso").val("");
            $("#txtImportePoliza").val("");
            cargarCMBMonedaCostoUnitario(100, "cmbMonedaPrecioPoliza");
            $("#txtAgenteSeguros").val("");
            $("#txtTelefonoAgente").val("");
            $("#txtTelefonoSiniestros").val("");

            SeguirDatosServicios(_global.PKVehiculo);
          } else {
            Lobibox.notify("error", {
              size: "mini",
              rounded: true,
                      ...
                      <form id="formDatosServicios"> 
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-2" style="text-align:center!important; margin-top:35px;">
                              <a href="#" class="btn-custom btn-custom--blue float-right" id="btnContinuarPrestamos">Continuar </a>
                            </div>
                          </div>
                        </div>
...
$(document).on("click", "#btnContinuarPrestamos", function () {
  SeguirBitacoraPrestamos(_global.PKVehiculo);
});
      ...
      $.ajax({
        ...
        success: function (respuesta) {
          if (respuesta[0].haveOpen==0) {
            ...
            } else if(respuesta[0].isCreatePdf==0){
...
$(document).on("click", "#btnTerminarRegistroVehiculo", function () {
