    ...
    require_once('../../../../../include/db-conn.php');
      if(isset ($_POST['btnAgregar'])){
        ...
        if(isset($_GET['id'])){
          ...
          try{
            $stmt = $conn->prepare('INSERT INTO cuentas_bancarias_proveedores (FKBanco,FKProveedor,No_de_cuenta,CLABE)VALUES(:banco,:proveedor,:cuenta,:clabe)');
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                ...
                                <div class="input-group mb-3">
                                  <input type="text" class="form-control alphaNumeric-only" maxlength="24" name="txtCuenta" required>
                                </div>
                              </div>
                              <div class="col-lg-4">
