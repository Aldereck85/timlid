...
<body id="page-top" class="sidebar-toggled">
              ...
              <div class="table-responsive">
                <table class="table" id="tblDatosGenerales" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div style="text-align: left;"> Saldo: <span id="saldoG"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div style="text-align: left;"> Tipo de cuenta: <span id="tipoCuentaG"></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div style="text-align: left;"> Nombre de la cuenta: <span id="nomCuentaG"></span></div>
                      </td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <input type="hidden" id="pkCuenta" name="pkCuenta" value="<?= $idDet; ?>">
              <div class="row">
                <div class="col-9">
                  <button type="button" class="btn-table-custom btn-table-custom--green" data-toggle="modal" data-target="#" onclick="ir_ModalInyeccion(<?= $idDet; ?>)"><i class="fas fa-plus-circle"></i> Agregar Dinero</button>
                  <button type="button" class="btn-table-custom btn-table-custom--red" data-toggle="modal" data-target="#retiro_Gasto" onclick="retiro_Gasto(<?= $idDet; ?>)"><i class="fas fa-minus-circle"></i> Retirar Dinero</button>
                  <button type="button" class="btn-table-custom btn-table-custom--blue-light" data-toggle="modal" data-target="#inyeccion_CapitalO" onclick="abrirModalTransferO(<?= $idDet; ?>)"><i class="fas fa-exchange-alt"></i> Transferir</button>
                  <button type="button" class="btn-table-custom btn-table-custom--yellow" data-toggle="modal" data-target="ajuste_Modal" onclick="modalAjusteOtros(<?= $idDet; ?>)"><i class="fas fa-sliders-h"></i> Ajuste</button>
                </div>
                <div class="col-3">
  ...
  <div class="modal fade right" id="inyeccion_Capital" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="overflow-y: scroll;">
    <div class="modal-dialog modal-full-height modal-right  modal-md" role="document">
      <div class="modal-content">
        <form name="formular" action="" id="inyeccionCapital" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  <input class="form-control numericDecimal-only" placeholder="Ej: 00.00" type="numeric" id="montoInyeccionCapital" onkeyup="validEmptyInput(this)" required>
                  <div class="invalid-feedback" id="invalid-montoOtras">La transacción debe tener un monto.</div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="invalid-feedback" id="invalid-fechaOtras">La transacción debe tener una fecha.</div>
            </div>

            <div class="form-group">
              <label for="usr">Observaciones:*</label>
              <textarea class="form-control" placeholder="" type="text" id="areaObservacion" required onkeyup="validEmptyInput(this)"></textarea>
              <div class="invalid-feedback" id="invalid-obsOtras">La transacción debe tener una descripcción.</div>
            </div>
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <div class="invalid-feedback" id="invalid-archivoOtras">La transacción debe tener un archivo de
                  comprobación.</div>
              </div>
            </div>
            <div class="modal-footer justify-content-center">
              ...
              <button type="button" class="btnesp first espAgregar " id="btnAgregarInyeccionCapital" onclick="agregar_InyeccionCapitalOtras()"><span class="ajusteProyecto" disabled>Guardar</span></button>
            </div>
        ...
        <form name="formular" action="" id="transferencia" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <select class="form-control" name="cmbCuentaDestinoCj" id="cmbCuentaDestinoCj" onchange="getMonedaDes(<?= $idDet; ?>)"></select>
            ...
            <div class="modal-footer justify-content-center">
              <button type="button" class="btnesp first espCancelar btnCancelarActualizacion" data-dismiss="modal" id="btnCancelarTransfer"><span class="ajusteProyecto">Cancelar</span></button>
              <button type="button" class="btnesp first espAgregar " id="btnGuardarTransferencia" onclick="guardarTransferenciaO()"><span class="ajusteProyecto">Guardar</span></button>
            </div>
          </div> <!-- end div Class MODAL BODY-->
        </form>
      </div>
        ...
        <form name="formular" action="" id="ajuste" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  ...
                  <div class="invalid-feedback" id="invalid-cantidadAjusOtr">El ajuste debe tener una cantidad.
                  </div>
                </div>
                <div class="col">
            ...
            <div class="form-group">
              <div class="d-flex">
                <div class="form-check mr-3">
                  <input class="form-check-input" type="radio" name="ajusteOtr" id="ajsutePositivo" value="positivo" onchange="validEmptyInput(this, 'invalid-tipoAjusOtr')" checked>
                  <label class="form-check-label" for="ajsutePositivo">
                    Ajuste positivo
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="ajusteOtr" id="ajusteNegativo" value="negativo" onchange="validEmptyInput(this, 'invalid-tipoAjusOtr')">
                  <label class="form-check-label" for="ajusteNegativo">
                    Ajuste negativo
                  </label>
                </div>
              </div>
              <div class="invalid-feedback" id="invalid-tipoAjusOtr">El ajuste debe tener un tipo de ajuste.
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="invalid-feedback" id="invalid-fechaAjusOtr">El ajuste debe tener una fecha.
              </div>
            </div>
            <div class="form-group">
              <label for="usr">Observaciones:* </label>
              ...
              <div class="invalid-feedback" id="invalid-obsAjusOtr">El ajuste debe tener una cantidad.
              </div>
            </div>
            <div class="modal-footer justify-content-center">
              <button type="button" class="btnesp first espCancelar btnCancelarAjuste" data-dismiss="modal" id="btnCancelarAjuste"><span class="ajusteProyecto">Cancelar</span></button>
              <button type="button" class="btnesp first espAgregar " id="btnGuardarAjuste" onclick="guardarAjusteOtros()"><span class="ajusteProyecto">Guardar</span></button>
            </div>
          </div> <!-- end div Class MODAL BODY-->
        </form>
      </div>
    ...
    <div class="modal-dialog modal-full-height modal-right  modal-md" role="document">
      <div class="modal-content">
        <form method="POST" name="retiroGasto" action="" id="retiroGasto">
          <input type="hidden" id="emp_id" name="emp_id" value="<?= $idemp; ?>">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="usr">Fecha del movimiento: *</label>
              <input class="form-control" style="border:none;" value="<?= $fecha; ?>" type="date" min="2021-01-01" max="2030-01-01" id="txtFechaGasto" name="txtFechaGasto" required onchange="validEmptyInput(this)">
            ...
            <div class="form-group">
              <label for="usr">Observaciones: *</label>
              <textarea class="form-control" name="areaDescripcionGasto" id="areaDescripcionGasto" type="text" required onkeyup="validEmptyInput(this)"></textarea>
              <div class="invalid-feedback" id="invalid-observRet">El retiro debe tener observaciones.
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="modal-footer justify-content-center">
              ...
              <button type="button" class="btnesp first espAgregar" onclick="guarda_MovimientoO()" id=""><span class="ajusteProyecto" disabled>Guardar</span></button>
            </div>
          </div> <!-- end div Class MODAL BODY-->
        </form>
      </div>
  ...
  <script src="js/funciones_Otras.js" charset="utf-8"></script>
  ...
  <script>
    ...
    $("#checkCajaInyeccion").change(function() {
      ...
      document.getElementById("invalid-archivoOtras").style.display = "none";
      if (this.checked) {
