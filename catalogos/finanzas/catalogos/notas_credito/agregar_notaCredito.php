...
<head>
  ...
  <title>Timlid | Agregar nota de crédito</title>
  ...
  <script src="../../js/agregar_notasCredito.js" charset="utf-8"></script>
  ...
  <link href="../../style/agregar_notasCredito.css" rel="stylesheet">
</head>
                              ...
                              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-12 input-group">
                                      <select name="cmbTipoGral" id="cmbTipoGral" required>
